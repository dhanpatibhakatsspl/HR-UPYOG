...
<body onload="disableTypeForEditMode()">
	<s:form action="receiptSearch" theme="simple">
		...
		<div class="formmainbox">
			...
			<s:else>
				<div class="subheadnew">
					<s:text name="receipt.search" />
				</div>
			</s:else>
			<table align="center" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td style="width: 5%"></td>
					<%-- <td class="greybox"><s:text name="receipt.type" /></td> --%>
					<td class="greybox"><s:textfield name="voucherNumber" type="hidden"
				...
				<tr>
					...
					<td class="bluebox"><s:text name="receipt.name" /></td>
