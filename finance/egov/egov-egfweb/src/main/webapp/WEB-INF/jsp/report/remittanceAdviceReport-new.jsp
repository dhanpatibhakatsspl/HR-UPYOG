...
<title><s:text name="remittance.advice.report" /></title>
	...
	<s:form action="bankAdviceReport" name="bankAdviceReport"
		...
		<div class="formmainbox">
			<div class="subheadnew">
				<s:text name="remittance.advice.report" />
			</div>
				...
				<s:if test="%{bankAdviseResultList.size>0}">
					...
					<s:iterator value="bankAdviseResultList" status="stat" var="p">
						<tr>
							...
							<td class="blueborderfortd" style="text-align: center"><s:property value="accountNumber" /></td>
