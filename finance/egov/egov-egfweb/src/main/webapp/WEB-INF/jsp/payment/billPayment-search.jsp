...
<body onload="disableTypeForEditMode()">
	<s:form action="billPayment-search" theme="simple">
		...
		<div class="formmainbox">
			...
			<s:else>
				<div class="subheadnew">
					<s:text name="lbl.bill.payment.search" />
				</div>
			</s:else>
			<table align="center" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td style="width: 5%"></td>
					<td class="bluebox"><s:text name="lbl.payment.type" /><span
					...
					<td class="bluebox"><s:text name="lbl.payment.name" /></td>
				...
				<tr>
					<td style="width: 5%"></td>
					<td class="greybox"><s:text name="lbl.payment.fromdate" /><span
						class="mandatory1" id="disableFromDateCheck">*</span></td>
					...
					<td class="greybox"><s:text name="lbl.payment.todate" /><span
				...
				<tr>
					<jsp:include page="../voucher/payment-filter.jsp" />
				</tr>
				<!-- tr>
					<td style="width: 5%"></td>
