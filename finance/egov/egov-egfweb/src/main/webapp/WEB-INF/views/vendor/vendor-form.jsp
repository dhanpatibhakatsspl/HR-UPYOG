...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="code"> <spring:message
			code="vendor.code" text='Code' /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
		 <c:if test="${!VendorCodeAutoGeneration}">
			<form:input path="code" maxlength="50" cssClass="form-control patternvalidation" data-pattern="alphanumericwithspace" required="required" value="${VendorCodeAutoGeneration}"  />
	...
	<label class="col-sm-2 control-label text-right" for="name"> <spring:message
			code="vendor.name" text='Name' /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right"
		for="correspondenceAddress"> <spring:message
			code="vendor.correspondenceAddress" text='Correspondence Address' /><span
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="contactPerson">
		<spring:message code="vendor.contactPerson" text='Contact Person' /><span
		class="mandatory"></span>
	</label>
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="tinNumber">
		<spring:message code="vendor.tinNo" text='GST/TIN No' /><span
		class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right"
		for="gstRegisteredState"> <spring:message
			code="vendor.gst.registered.state" text='GST registered State/UT' /><span
		class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="bank"> <spring:message
			code="vendor.bank" text='Bank' /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right" for="ifscCode">
		<spring:message code="vendor.ifscCode" text='IFSC Code' /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="bankAccount">
		<spring:message code="vendor.bankAccount"
			text='Bank Account Number' /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	...
	<div class="col-sm-2 col-xs-12 add-margin">
		<div class="radio">
			<label><form:radiobutton path="vendorType"
					id="vendorType" value="FIRM" checked="checked" />
	...
	<div class="col-sm-2 col-xs-12 add-margin">
		<div class="radio">
			<label><form:radiobutton path="vendorType"
					id="vendorType" value="INDIVIDUALS" />
				<spring:message code="lbl.individuals" /></label>
		</div>
	</div>
	<form:errors path="vendorType" cssClass="error-msg" />
</div>
<div>
	<div class="form-group" id="registerationNo" style="display: none">
		<label class="col-sm-2 control-label text-right"
			for="registrationNumber"> <spring:message
				code="vendor.registrationNo" text='Registration No' /><span class="mandatory"></span>
		</label>
		<div class="col-sm-3 add-margin">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label text-right" for="status">
			<spring:message code="vendor.status" text='Status' /><span
			class="mandatory"></span>
		</label>
		<div class="col-sm-3 add-margin">
		...
		<label class="col-sm-2 control-label text-right" for="panNumber">
			<spring:message code="vendor.panNo" text='PAN No' /><span class="mandatory"></span>
		</label>
		<div class="col-sm-3 add-margin">
	...
	<input type="text" name="vendor" value="${vendor.id}" />