				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						 <div class="form-group">
						    <label class="col-sm-5 control-label text-right">
						     ...
						     <div class="col-sm-3 add-margin">
                                <form:input path="startingDate" id="startDate" class="form-control datepicker" data-date-end-date="0d"  placeholder="DD/MM/YYYY"/>
						...
						<div class="form-group">
						    ...
						    <div class="col-sm-3 add-margin">
                                <form:input path="endingDate" id="endDate" class="form-control datepicker" data-date-end-date="0d" placeholder="DD/MM/YYYY" onchange="validateEndDate()" />
                                <!-- data-inputmask="'mask': 'd/m/y'" -->
...
<script type="text/javascript">
    // Global function for parsing date
