			...
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading">
					<div class="panel-title">
						<spring:message code="lbl.supplier" text="Supplier" />
					</div>
				</div>
				<div class="panel-body custom">
					...
					<div class="row add-border">
						...
						<div class="col-xs-3 add-margin">
							<spring:message code="supplier.source" text="Source" />
						</div>
						<div class="col-sm-3 add-margin view-content">${supplier.source}</div>
					</div>
					<div class="row add-border">
						<div class="col-xs-3 add-margin">
						...
						<div class="col-sm-3 add-margin view-content">${supplier.supplierType}</div>
					</div>
					<c:choose>
						<c:when test="${supplier.supplierType =='FIRM'}">
							<div class="row add-border">
								<div class="col-xs-3 add-margin">
