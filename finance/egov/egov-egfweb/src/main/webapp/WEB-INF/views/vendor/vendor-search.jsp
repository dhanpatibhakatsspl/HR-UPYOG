...
<form:form role="form" action="search" modelAttribute="vendorSearchRequest" id="vendorsearchform"
      ...
      <div class="col-md-12">
        <div class="panel panel-primary" data-collapsed="0">
          <div class="panel-heading">
            <div class="panel-title"><spring:message code="title.vendor.search" text="Search Vendor"/> </div>
          </div>
...
<div class="row display-hide report-section">
  <div class="col-md-12 table-header text-left"><spring:message code="lbl.vendor.search.result" text="Vendor Search Result"/> </div>
    ...
    <table class="table table-bordered table-hover multiheadertbl" id="resultTable">
      <thead>
        <tr>
          ...
          <th><spring:message code="vendor.status" text="Status"/></th>
        </tr>
      </thead>
    </table>
  </div>
...
<script type="text/javascript" src="<cdn:url value='/resources/app/js/vendorHelper.js?rnd=${app_release_no}' context='/services/EGF'/>"></script>
