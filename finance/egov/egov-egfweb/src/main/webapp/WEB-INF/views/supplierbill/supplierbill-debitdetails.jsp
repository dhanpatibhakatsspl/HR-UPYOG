			...
			<c:choose>
				<c:when test="${egBillregister.debitDetails.size() == 0}">
					<tr id="debitdetailsrow">
						...
						<td>
							<form:input path="debitDetails[0].debitamount" id="debitDetails[0].debitamount"  data-errormsg="Debit Amount is mandatory!" onkeyup="decimalvalue(this);" onblur="calcualteNetpaybleAmount(); comparePreviousBillAmountWithPurchaseOrderValue();" data-pattern="decimalvalue" data-idx="0" data-optional="0" class="form-control table-input text-right debitAmount"   maxlength="12"  />
						</td> 
