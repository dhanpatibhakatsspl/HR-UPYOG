...
<form:form role="form" action="create" modelAttribute="vendor" id="vendorform" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
<div class="main-content">
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary" data-collapsed="0">
				<div class="panel-heading control-label">
					 <div class="panel-title"><spring:message code="title.vendor.create" text="Vendor Master"/></div>
				</div>
