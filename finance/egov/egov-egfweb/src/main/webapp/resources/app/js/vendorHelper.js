...
$(document).ready(function(){	
	...
	refreshViewFromRadionOptionValue($('input[name=vendorType]:checked').val(), true);
	
	$('input[type=radio][name=vendorType]').change(function() {
...
function callAjaxSearch() {
	...
	reportdatatable = drillDowntableContainer
			.dataTable({
				ajax : {
					url : "/services/EGF/vendor/ajaxsearch/" + $('#mode').val(),
					type : "POST",
				...
				"fnRowCallback" : function(row, data, index) {
					$(row).on(
							...
							function() {
								console.log(data.id);
								window.open('/services/EGF/vendor/' + $('#mode').val()
										+ '/' + data.id, '',
