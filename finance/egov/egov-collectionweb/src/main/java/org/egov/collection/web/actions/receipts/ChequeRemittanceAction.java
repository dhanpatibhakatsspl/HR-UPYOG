...
@Results({ @Result(name = BankRemittanceAction.NEW, location = "chequeRemittance-new.jsp"),
...
@ParentPackage("egov")
public class ChequeRemittanceAction extends GenericWorkFlowAction {
...
//                voucher();
		...
		remittedReceiptList = remittanceService.createChequeBankRemittance(finalBeanList, accountNumberId,
