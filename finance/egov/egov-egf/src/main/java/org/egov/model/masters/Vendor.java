...
import org.egov.enums.VendorTypeEnum;
...
@Entity
@Table(name = "EGF_VENDOR")
@Unique(id = "id", tableName = "EGF_VENDOR", columnName = { "code", "tinNumber" }, fields = { "code",
        "tinNumber" }, enableDfltMsg = true)
@SequenceGenerator(name = Vendor.SEQ_EGF_VENDOR, sequenceName = Vendor.SEQ_EGF_VENDOR, allocationSize = 1)
public class Vendor extends AbstractAuditable implements EntityType {

    private static final long serialVersionUID = 2507334170114202599L;

    public static final String SEQ_EGF_VENDOR = "SEQ_EGF_VENDOR";

    @Id
    @GeneratedValue(generator = SEQ_EGF_VENDOR, strategy = GenerationType.SEQUENCE)
    private Long id;
