  ...
  (0, _createClass3.default)(ComplaintAssigned, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _common.Screen,
        { loading: loading, className: "padding-0" },
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var _complaints$loading = complaints.loading,
      loading = _complaints$loading === undefined ? false : _complaints$loading,
      _complaints$error = complaints.error,
      error = _complaints$error === undefined ? false : _complaints$error,
      _complaints$errorMess = complaints.errorMessage,
      errorMessage = _complaints$errorMess === undefined ? "" : _complaints$errorMess;

  var selectedComplaint = complaints["byId"][decodeURIComponent(window.location.href.split("/").pop())];
  var selectedEmployee = selectedComplaint && employeeById && employeeById[selectedComplaint.actions[0].assignee];
  var employeeDetails = {
  ...
  return { employeeDetails: employeeDetails, fetchSuccess: fetchSuccess, loading: loading, errorMessage: errorMessage, error: error };
};
