...
var ListCard = function (_Component) {
  ...
  function ListCard() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ListCard.__proto__ || Object.getPrototypeOf(ListCard)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      right: 30,
      margin: "0px"
    }, _this.getItemForDepartment = function (item, department) {
      return (0, _extends3.default)({}, item, {
        assignments: item.assignments.filter(function (assignmentItem) {
          return assignmentItem.department === department;
        })
      });
      ...
      var seperateByDepartment = rawData && rawData.reduce(function (result, item) {
        for (var i = 0; i < item.assignments.length; i++) {
          ...
          result[item.assignments[i].department].push(_this.getItemForDepartment(item, item.assignments[i].department));
        }
        return result;
      }, {});
      return seperateByDepartment && Object.keys(seperateByDepartment).map(function (depDetails, index) {
        return {
          ...
          primaryText: _react2.default.createElement(_translationNode2.default, {
            label: (0, _commons.getNameFromId)(departmentById, depDetails, "COMMON_MASTERS_DEPARTMENT_" + depDetails),
            dark: true,
            bold: true,
          ...
          nestedItems: seperateByDepartment[depDetails].map(function (depItem, depItemIndex) {
            return {
              ...
              secondaryText: _react2.default.createElement(_translationNode2.default, {
                label: depItem && depItem.assignments && (0, _commons.getNameFromId)(designationsById, depItem.assignments[0].designation, "COMMON_MASTERS_DESIGNATION_" + depItem.assignments[0].designation),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !isEmployeeDirectory && _react2.default.createElement(
          "div",
          { className: "responsive-action-button-cont assign-button" },
