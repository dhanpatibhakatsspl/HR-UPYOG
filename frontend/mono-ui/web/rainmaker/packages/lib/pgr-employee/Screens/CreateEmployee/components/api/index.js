...
var tenantId = (0, _localStorageUtils.getTenantId)() ? (0, _localStorageUtils.getTenantId)() : "default";
...
module.exports = {
  commonApiPost: function commonApiPost(context) {
    ...
    if (!doNotOverride) {
      if (url.split("?").length > 1) {
        url += "&tenantId=" + ((0, _localStorageUtils.getTenantId)() ? isStateLevel ? _common2.default.tenantId : (0, _localStorageUtils.getTenantId)() : "default");
      } else {
        url += "?tenantId=" + ((0, _localStorageUtils.getTenantId)() ? isStateLevel ? _common2.default.tenantId : (0, _localStorageUtils.getTenantId)() : "default");
      }
    } else {
  ...
  commonApiGet: function commonApiGet(context) {
    ...
    var url = context;
    if (!doNotOverride) url += "?tenantId=" + ((0, _localStorageUtils.getTenantId)() || "default");else url += "?";
    for (var variable in queryObject) {
      if (typeof queryObject[variable] !== "undefined") {
        url += "&" + variable + "=" + queryObject[variable];
      }
