...
var RequestReassignHOC = (0, _form2.default)({
  formKey: "requestReassign",
  isCoreConfiguration: true,
  path: "pgr/pgr-employee"
})(_RequestReassignForm2.default);
...
var RequestReAssign = function (_Component) {
  ...
  function RequestReAssign() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = RequestReAssign.__proto__ || Object.getPrototypeOf(RequestReAssign)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      label: _react2.default.createElement(_translationNode2.default, { label: "ES_REASSIGN_OPTION_ONE" })
    }, {
      value: "Not my responsibility",
      label: _react2.default.createElement(_translationNode2.default, { label: "ES_REASSIGN_OPTION_TWO" })
    }, {
      value: "Absent or on leave",
      label: _react2.default.createElement(_translationNode2.default, { label: "ES_REASSIGN_OPTION_THREE" })
    }, { value: "Other", label: _react2.default.createElement(_translationNode2.default, { label: "ES_REASSIGN_OPTION_FOUR" }) }], _this.commentsValue = {}, _this.handleCommentsChange = function (e, value) {
