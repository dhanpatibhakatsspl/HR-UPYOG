...
var makeAjaxUpload = function makeAjaxUpload(file, cb) {
  if (file.constructor == File) {
    ...
    formData.append('jurisdictionId', (0, _localStorageUtils.getTenantId)());
  ...
  function Employee(props) {
      ...
      switch (_this.state.modal) {
        case 'assignment':
          ...
          if (self.getDate(_this.state.subObject.assignments.fromDate).getTime() > self.getDate(_this.state.subObject.assignments.toDate).getTime()) {
            return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.date'), false, "error");
          }
          ...
          if (!validateDates(_this.props.Employee, asst, editIndex)) {
            return _this.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.assignmentDate'), false, "error");
          }
        ...
        case 'jurisdiction':
          ...
          if (!checkIfNoDup(_this.props.Employee, jst)) {
            return _this.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.dupAssignment'), false, "error");
          }
    ...
    _this.initDat = function () {
      ...
      _api2.default.commonApiGet('egov-location/boundarys', {
        'Boundary.tenantId': (0, _localStorageUtils.getTenantId)()
      }).then(function (res) {
      ...
      switch (type) {
        ...
        case 'appointmentDate':
          ...
          if (self.props.Employee.dateOfRetirement) {
            ...
            if (date > date1) return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.appDate.retDate'), false, "error");
          }
          ...
          if (self.props.Employee.dateOfTermination) {
            ...
            var newDateStr = dateParts1[1] + '/' + dateParts1[0] + '/ ' + dateParts1[2];
            var date1 = new Date(newDateStr).getTime();
            if (date > date1) return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.appDate.terDate'), false, "error");
          }
          ...
          if (self.props.Employee.dateOfResignation) {
            ...
            var newDateStr = dateParts1[1] + '/' + dateParts1[0] + '/ ' + dateParts1[2];
            var date1 = new Date(newDateStr).getTime();
            if (date > date1) return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.appDate.regDate'), false, "error");
          }
          ...
          if (self.props.Employee.dateOfJoining) {
            ...
            var newDateStr = dateParts1[1] + '/' + dateParts1[0] + '/ ' + dateParts1[2];
            var date1 = new Date(newDateStr).getTime();
            if (date > date1) return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.appDate.joinDate'), false, "error");
          }
          break;
        case 'joiningDate':
          name = 'dateOfJoining';
          ...
          if (self.props.Employee.dateOfRetirement) {
            ...
            var newDateStr = dateParts1[1] + '/' + dateParts1[0] + '/ ' + dateParts1[2];
            var date1 = new Date(newDateStr).getTime();
            if (date > date1) return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.retDate.joinDate'), false, "error");
          }
          ...
          if (self.props.Employee.dateOfTermination) {
            ...
            var newDateStr = dateParts1[1] + '/' + dateParts1[0] + '/ ' + dateParts1[2];
            var date1 = new Date(newDateStr).getTime();
            if (date > date1) return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.joinDate.terDate'), false, "error");
          }
          ...
          if (self.props.Employee.dateOfResignation) {
            ...
            var newDateStr = dateParts1[1] + '/' + dateParts1[0] + '/ ' + dateParts1[2];
            var date1 = new Date(newDateStr).getTime();
            if (date > date1) return self.props.toggleSnackbarAndSetText(true, (0, _Common.translate)('employee.error.message.joinDate.regDate'), false, "error");
          }
          break;
        case 'retirementDate':
