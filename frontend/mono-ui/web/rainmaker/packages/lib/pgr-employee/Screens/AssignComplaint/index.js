...
var AssignComplaintFormHOC = (0, _form2.default)({
  formKey: "assignComplaint",
  isCoreConfiguration: true,
  path: "pgr/pgr-employee"
})(_AssignComplaintForm2.default);
...
var AssignComplaint = function (_Component) {
  ...
  function AssignComplaint() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = AssignComplaint.__proto__ || Object.getPrototypeOf(AssignComplaint)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
      ...
      var queryParams = [{ key: "roles", value: "EMPLOYEE" }, { key: "tenantId", value: (0, _localStorageUtils.getTenantId)() }];
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var transformedComplaint = {
    ...
    address: selectedComplaint ? selectedComplaint.addressDetail && !(0, _isEmpty2.default)(selectedComplaint.addressDetail) ? selectedComplaint.addressDetail : selectedComplaint.address : ""
  };
  return {
