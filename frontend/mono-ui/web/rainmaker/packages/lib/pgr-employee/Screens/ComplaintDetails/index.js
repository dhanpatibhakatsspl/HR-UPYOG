...
var ComplaintDetails = function (_Component) {
  ...
  function ComplaintDetails() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ComplaintDetails.__proto__ || Object.getPrototypeOf(ComplaintDetails)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    }, _this.ShareButtonOnClick = function () {
      var complaintData = _this.props.transformedComplaint.complaint;
      var name = complaintData.filedBy ? complaintData.filedBy : "NA";
      var moblileNo = complaintData.filedUserMobileNumber ? complaintData.filedUserMobileNumber : "NA";
      var complaintNo = complaintData.applicationNo ? complaintData.applicationNo : "NA";
      var complaintType = _this.props.complaintTypeLocalised ? _this.props.complaintTypeLocalised : "NA";
      var address = complaintData.address ? complaintData.address : "NA";
      ...
      var shareMetaData = {
        ...
        shareContent: [{
          to: "",
          content: { name: name, moblileNo: moblileNo, complaintNo: complaintNo, complaintType: complaintType, address: address },
          expiredIn: "",
          documents: []
        }],
    ...
    }, _this.shareCallback = function () {
      var complaint = _this.props.transformedComplaint.complaint;


      navigator.share({
        title: "Complaint Summary",
        text: "Dear Sir/Madam,\nPlease find complaint detail given below :\n" + (0, _get2.default)(complaint, "filedBy", "") + ", " + (0, _get2.default)(complaint, "filedUserMobileNumber", "") + ",\n" + (0, _get2.default)(complaint, "complaint", "") + ", " + (0, _get2.default)(complaint, "description", "") + "\nAddress: " + (0, _get2.default)(complaint, "addressDetail.houseNoAndStreetName", "") + ",\n" + (0, _get2.default)(complaint, "addressDetail.locality", "") + ",\n" + (0, _get2.default)(complaint, "addressDetail.landMark", "") + "\nSLA: " + (0, _get2.default)(complaint, "timelineSLAStatus.slaStatement", "") + "\nThanks",
        url: ""
      }).then(function () {
  ...
  (0, _createClass3.default)(ComplaintDetails, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          prepareFormData = _props.prepareFormData,
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var _props2 = this.props,
          transformedComplaint = _props2.transformedComplaint,
          prepareFormData = _props2.prepareFormData;

      if (!(0, _isEqual2.default)(transformedComplaint, nextProps.transformedComplaint)) {
    ...
    value: function render() {
      ...
      var shareCallback = this.shareCallback;
      ...
      var _props3 = this.props,
          role = _props3.role,
          serviceRequestId = _props3.serviceRequestId,
          history = _props3.history,
          isAssignedToEmployee = _props3.isAssignedToEmployee,
          reopenValidChecker = _props3.reopenValidChecker;
        ...
        _react2.default.createElement(
          ...
          complaint && !openMap && _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_common.Comments, {
                comments: comments,
                role: role,
            ...
            _react2.default.createElement(
              "div",
              null,
              role === "ao" && complaint.complaintStatus.toLowerCase() !== "closed" || role === "employee" && isAssignedToEmployee && complaint.complaintStatus.toLowerCase() === "assigned" && complaint.complaintStatus.toLowerCase() !== "closed" ? _react2.default.createElement(_common.ActionButton, {
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var reopenValidChecker = (0, _get2.default)(state, "common.pgrContants.RAINMAKER-PGR.UIConstants[0].REOPENSLA", 4232000000);
  ...
  if (selectedComplaint) {
    ...
    var complaintTypeLocalised = (0, _commons.getTranslatedLabel)(("SERVICEDEFS." + transformedComplaint.complaint.complaint).toUpperCase(), localizationLabels);

    return {
      form: form,
      transformedComplaint: transformedComplaint,
      role: role,
      serviceRequestId: serviceRequestId,
      isAssignedToEmployee: isAssignedToEmployee,
      complaintTypeLocalised: complaintTypeLocalised,
      reopenValidChecker: reopenValidChecker
    };
  } else {
    return {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    sendMessage: function sendMessage(message) {
      return dispatch((0, _actions3.sendMessage)(message));
    },
    sendMessageMedia: function sendMessageMedia(message) {
      return dispatch((0, _actions3.sendMessageMedia)(message));
    },
    prepareFormData: function prepareFormData(jsonPath, value) {
      return dispatch((0, _actions2.prepareFormData)(jsonPath, value));
    }
  };
};
