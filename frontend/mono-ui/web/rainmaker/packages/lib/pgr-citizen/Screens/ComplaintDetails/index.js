...
var getServiceId = function getServiceId() {
  ...
  var id = param && decodeURIComponent(param.split('&')[0]);
  return id;
};
  ...
  (0, _createClass3.default)(ComplaintDetails, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          reopenValidChecker = _props2.reopenValidChecker;
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var selectedComplaint = complaints["byId"][getServiceId(ownProps.match.params.serviceRequestId)];
  ...
  if (selectedComplaint) {
    ...
    return { form: form, transformedComplaint: transformedComplaint, reopenValidChecker: reopenValidChecker };
  } else {
    return { form: form, transformedComplaint: {}, reopenValidChecker: reopenValidChecker };
  }
};
