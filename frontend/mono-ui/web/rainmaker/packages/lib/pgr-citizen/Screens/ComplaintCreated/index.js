...
var ComplaintCreated = function ComplaintCreated(props) {
  return _react2.default.createElement(_common.ComplaintSubmited
  /* Mseva 2.0 changes */
  , (0, _extends3.default)({ homeRoute: "/",
    lastLabel: _react2.default.createElement(_translationNode2.default, {
