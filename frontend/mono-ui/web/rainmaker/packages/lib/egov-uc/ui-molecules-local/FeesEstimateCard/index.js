...
function FeesEstimateCard(props) {
  ...
  var isPaid = estimate.payStatus;
  var totalHeadClassName = "uc-total-amount-value " + classes.bigheader;
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _Grid2.default,
          { container: true },
          estimate.fees && estimate.fees.map(function (fee, key) {
            //Removed tooltip for now
            var tooltip = fee.info && false ? _react2.default.createElement(
              _Tooltip2.default,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Grid2.default,
            {
              ...
              className: "uc-application-table-total-value"
            },
            _react2.default.createElement(
              _Typography2.default,
              { variant: "body2" },
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _Typography2.default,
        {
          variant: "body2",
          align: "right",
          className: "uc-total-amount-text"
        },
        _react2.default.createElement(_uiContainers.LabelContainer, {
          labelName: "Total Amount",
          labelKey: "UC_COMMON_TOTAL_AMT"
