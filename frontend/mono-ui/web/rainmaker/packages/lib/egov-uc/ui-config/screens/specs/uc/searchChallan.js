...
var _searchChallanCard = require("./universalCollectionResources/searchChallanCard");
...
var _searchChallanResults = require("./universalCollectionResources/searchChallanResults");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            //   dispatch
            // ); 
            dispatch((0, _actions.prepareFinalObject)("applyScreenMdmsData.BillingService.BusinessService", (0, _get2.default)(payload.MdmsRes, "BillingService.BusinessService")));
...
var SearchChallanAndResult = {
  uiFramework: "material-ui",
  name: "searchChallan",
  beforeInitScreen: function beforeInitScreen(action, state, dispatch) {
    dispatch((0, _actions.prepareFinalObject)("challanSearchScreen", {}));
  ...
  components: {
    div: {
      ...
      children: {
        ...
        SearchChallanCard: _searchChallanCard.SearchChallanCard,
        breakAfterSearch: (0, _utils.getBreak)(),
        SearchChallanResults: _searchChallanResults.SearchChallanResults
      }
    }
  }
};

var openNewChallanForm = function openNewChallanForm(state, dispatch) {

  dispatch((0, _actions2.setRoute)("/uc/newCollection"));
};

exports.default = SearchChallanAndResult;