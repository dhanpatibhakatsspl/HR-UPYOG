...
var callBackForPay = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(state, dispatch) {
    var href, isFormValid, selectedPaymentType, _getSelectedTabIndex, selectedTabIndex, selectedPaymentMode, fieldsToValidate, bankName, branchName, ReceiptDataTemp, finalReceiptData, ReceiptBody, response, receiptNumber, serviceCategory;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (selectedPaymentType === "Cheque" || selectedPaymentType === "DD") {
              bankName = (0, _get2.default)(state.screenConfiguration.preparedFinalObject, "ReceiptTemp[0].instrument.bank.name", null);
              branchName = (0, _get2.default)(state.screenConfiguration.preparedFinalObject, "ReceiptTemp[0].instrument.branchName", null);

              if (!bankName && !branchName) {
                dispatch((0, _actions.prepareFinalObject)("ReceiptTemp[0].instrument.ifscCode", null));
              }
            }
            ...
            (0, _set2.default)(finalReceiptData, "Bill[0].mobileNumber", (0, _get2.default)(state.screenConfiguration, "preparedFinalObject.Demands[0].mobileNumber", ""));

            //Add comments
            (0, _set2.default)(finalReceiptData, "Bill[0].billDetails[0].additionalDetails.comment", (0, _get2.default)(state.screenConfiguration, "preparedFinalObject.Demands[0].additionalDetails.comment", ""));
...
var goBack = function goBack(state, dispatch) {
  var demand = (0, _get2.default)(state.screenConfiguration.preparedFinalObject, "Demands[0]", []);
  var demandId = demand.id || null;
  if (demandId) {
    var serviceType = (0, _get2.default)(demand, "serviceType");
    var serviceCategory = (0, _get2.default)(demand, "businessService");
  }
  dispatch((0, _actions2.setRoute)("/uc/newCollection"));
};