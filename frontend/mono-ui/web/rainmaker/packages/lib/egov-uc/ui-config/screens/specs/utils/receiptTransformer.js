      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            data.comments = nullToNa((0, _get2.default)(response, "Bill[0].billDetails[0].additionalDetails.comment", "NA"));
            ...
            data.g8ReceiptDate = nullToNa(epochToDate((0, _get2.default)(response, "Bill[0].billDetails[0].manualReceiptDate", null)));
