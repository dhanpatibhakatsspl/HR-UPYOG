...
exports.searchPropertyDetails = exports.resetFields = undefined;

var _utils = require("egov-ui-framework/ui-config/screens/specs/utils");

var _actions = require("egov-ui-framework/ui-redux/screen-configuration/actions");

var _searchFunctions = require("./searchResource/searchFunctions");

var resetFields = exports.resetFields = function resetFields(state, dispatch) {
  if (process.env.REACT_APP_NAME == "Citizen") {
    dispatch((0, _actions.handleScreenConfigurationFieldChange)("propertySearch", "components.div.children.searchPropertyDetails.children.cardContent.children.ulbCityContainer.children.ulbCity", "props.value", ""));
    dispatch((0, _actions.prepareFinalObject)("searchScreen.tenantId", ''));
  }

  dispatch((0, _actions.handleScreenConfigurationFieldChange)("propertySearch", "components.div.children.searchPropertyDetails.children.cardContent.children.ulbCityContainer.children.ownerMobNo", "props.value", ""));
  dispatch((0, _actions.handleScreenConfigurationFieldChange)("propertySearch", "components.div.children.searchPropertyDetails.children.cardContent.children.ulbCityContainer.children.existingPropertyId", "props.value", ""));
  dispatch((0, _actions.handleScreenConfigurationFieldChange)("propertySearch", "components.div.children.searchPropertyDetails.children.cardContent.children.ulbCityContainer.children.propertyTaxUniqueId", "props.value", ""));
  dispatch((0, _actions.prepareFinalObject)("searchScreen.propertyIds", ''));
  dispatch((0, _actions.prepareFinalObject)("searchScreen.mobileNumber", ''));
  dispatch((0, _actions.prepareFinalObject)("searchScreen.oldpropertyids", ''));
};
  ...
  button: (0, _utils.getCommonContainer)({
    buttonContainer: (0, _utils.getCommonContainer)({
      ...
      searchButton: {
        ...
        onClickDefination: {
          action: "condition",
          callBack: _searchFunctions.propertySearch
        }
      }
    })
  })
