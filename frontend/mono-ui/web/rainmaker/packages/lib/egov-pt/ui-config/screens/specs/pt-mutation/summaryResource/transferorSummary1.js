...
var transferorSummary = exports.transferorSummary = (0, _utils.getCommonCard)({
  header: {
  ...
  cardOne: {
    ...
    props: {
      ...
      scheama: (0, _utils.getCommonCardWithNoShadow)({
...
var transferorInstitutionSummary = exports.transferorInstitutionSummary = (0, _utils.getCommonCard)({
  header: {
    uiFramework: "custom-atoms",
    componentPath: "Container",
    props: {
