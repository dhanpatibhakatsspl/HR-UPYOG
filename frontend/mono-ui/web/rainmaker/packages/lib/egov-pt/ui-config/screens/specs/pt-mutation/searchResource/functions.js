      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            isSearchBoxFirstRowValid = (0, _utils.validateFields)("components.div.children.NOCApplication.children.cardContent.children.appNOCAndMobNumContainer.children", state, dispatch, "search");
            isSearchBoxSecondRowValid = (0, _utils.validateFields)("components.div.children.NOCApplication.children.cardContent.children.appStatusAndToFromDateContainer.children", state, dispatch, "search");
          ...
          case 21:
            ...
            data = response.FireNOCs.map(function (item) {
              var _ref2;

              return _ref2 = {}, (0, _defineProperty3.default)(_ref2, (0, _utils.getTextToLocalMapping)("Application No"), item.fireNOCDetails.applicationNumber || "-"), (0, _defineProperty3.default)(_ref2, (0, _utils.getTextToLocalMapping)("NOC No"), item.fireNOCNumber || "-"), (0, _defineProperty3.default)(_ref2, (0, _utils.getTextToLocalMapping)("NOC Type"), item.fireNOCDetails.fireNOCType || "-"), (0, _defineProperty3.default)(_ref2, (0, _utils.getTextToLocalMapping)("Owner Name"), (0, _get2.default)(item, "fireNOCDetails.applicantDetails.owners[0].name") || "-"), (0, _defineProperty3.default)(_ref2, (0, _utils.getTextToLocalMapping)("Application Date"), (0, _index.convertEpochToDate)(parseInt(item.fireNOCDetails.applicationDate)) || "-"), (0, _defineProperty3.default)(_ref2, "tenantId", item.tenantId), (0, _defineProperty3.default)(_ref2, (0, _utils.getTextToLocalMapping)("Status"), item.fireNOCDetails.status || "-"), _ref2;
            });


            dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResults", "props.data", data));
            dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResults", "props.title", (0, _utils.getTextToLocalMapping)("Search Results for Fire-NOC Applications") + " (" + response.FireNOCs.length + ")"));
