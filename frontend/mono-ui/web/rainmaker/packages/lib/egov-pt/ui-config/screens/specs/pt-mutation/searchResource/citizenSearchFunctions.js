          ...
          case 2:
            ...
            try {
              if (response && response.Properties && response.Properties.length > 0) {
                dispatch((0, _actions.prepareFinalObject)("searchResults", response.Properties));
                dispatch((0, _actions.prepareFinalObject)("myApplicationsCount", response.Properties.length));
                dispatch((0, _actions.handleScreenConfigurationFieldChange)("my-applications", "components.div.children.header.children.key", "props.dynamicArray", response.Properties.length ? [response.Properties.length] : [0]));
              }
            } catch (error) {
              console.log(error);
            }
