...
var _ptAppConfig = require("../../ui-config/pt-app-config");
...
var MapLocator = function (_Component) {
  ...
  function MapLocator(props) {
    ...
    _this.onClickPick = function () {
      _this.props.handleField("apply", "components.div.children.formwizardSecondStep.children.propertyLocationDetails.children.cardContent.children.propertyDetailsConatiner.children.propertyGisCoordinates.children.gisTextField", "props.value", add.lat + ", " + add.lng);
      _this.props.prepareFinalObject("FireNOCs[0].fireNOCDetails.propertyDetails.address.latitude", add.lat);
      _this.props.prepareFinalObject("FireNOCs[0].fireNOCDetails.propertyDetails.address.longitude", add.lng);
  ...
  (0, _createClass3.default)(MapLocator, [{
    ...
    value: function render() {
      ...
      var _currloc = !(0, _isEmpty2.default)(currLoc) ? currLoc : (0, _isEmpty2.default)(location) ? _ptAppConfig.defaultLocation : location;
