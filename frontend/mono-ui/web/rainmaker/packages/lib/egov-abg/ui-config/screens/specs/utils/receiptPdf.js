...
exports.getTaxHeadtable = exports.generateSingleBill = exports.generateMultipleBills = exports.cancelGeneratedJob = exports.downloadMultipleBills = exports.generateMultipleBill = undefined;
...
var billTableWidthForConsumeDetails = ["*", "*", "*", "*"];
...
// For mutliple bills
var getMutlipleBillsData = function getMutlipleBillsData(transformedDataArray) {
  var multipleBillData = transformedDataArray.map(function (transformedData, index) {
    return getPdfContent(transformedData, transformedDataArray.length, index);
  });
  var finalMultipleBillData = {
...
var generateMultipleBill = exports.generateMultipleBill = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(state, dispatch, type) {
    var allBills, commonPayDetails, businessService, billkey, index, details;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            dispatch((0, _actions.toggleSpinner)());
            allBills = (0, _get2.default)(state.screenConfiguration, "preparedFinalObject.searchScreenMdmsData.billSearchResponse", []);
            commonPayDetails = (0, _get2.default)(state.screenConfiguration, "preparedFinalObject.searchScreenMdmsData.common-masters.uiCommonPay", []);
            businessService = (0, _get2.default)(state.screenConfiguration, "preparedFinalObject.searchCriteria.businesService", "");
            billkey = "";
            ...
            _context.next = 12;
            return (0, _commons.downloadMultipleBill)(allBills, billkey);
  ...
  return function generateMultipleBill(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

var downloadMultipleBills = exports.downloadMultipleBills = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
    ...
    var locality = arguments[3];
    var isConsolidated = arguments[4];
    var businesService = arguments[5];
    var consumerCode = arguments[6];
    var dispatch = arguments[7];
    var DOWNLOADRECEIPT, queryStr, resp;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            queryStr = [{ key: "key", value: configKey }, { key: "tenantId", value: tenantId || _common2.default.tenantId }, { key: "locality", value: locality }, { key: "isConsolidated", value: isConsolidated }];
            ...
            */
            _context2.next = 7;
            return (0, _uiUtils.httpRequest)("post", DOWNLOADRECEIPT.GET.URL, "create", queryStr);
          ...
          case 7:
            ...
            if (resp) {
              dispatch((0, _actions.toggleSnackbar)(true, {
                ...
                labelKey: (0, _commons2.getLocaleLabels)("GRP_JOB_INITIATED_STATUS", "GRP_JOB_INITIATED_STATUS") + " " + resp.jobId
              }, "success"));
          ...
          case 11:
            ...
            dispatch((0, _actions.toggleSnackbar)(true, _context2.t0.message, "error"));
  ...
  return function downloadMultipleBills() {
    return _ref2.apply(this, arguments);
  };
}();

var cancelGeneratedJob = exports.cancelGeneratedJob = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(dispatch, jobid) {
    var CANCEL, queryStr, resp;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            queryStr = [{ key: "jobId", value: jobid }];
            _context3.next = 5;
            return (0, _uiUtils.httpRequest)("post", CANCEL.GET.URL, "create", queryStr);
          ...
          case 5:
            ...
            if (resp) {
              dispatch((0, _actions.toggleSnackbar)(true, {
                ...
                labelKey: (0, _commons2.getLocaleLabels)("GRP_JOB_CANCELLED_STATUS", "GRP_JOB_CANCELLED_STATUS") + " " + jobid
              }, "success"));
              // window.location.href.includes("abg/billDownload")&&window.location.reload();
            }
            _context3.next = 13;
          ...
          case 9:
            ...
            dispatch((0, _actions.toggleSnackbar)(true, _context3.t0.message, "error"));
  ...
  return function cancelGeneratedJob(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();

//generateMutlipleBills PDF
var generateMultipleBills = exports.generateMultipleBills = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(state, dispatch, tenantId, locality, isConsolidated, businesService, consumerCode) {
    var allBills, commonPayDetails, businessService, billkey, index, details;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.t0 = allBills && allBills.length > 0;
            ...
            _context4.next = 12;
            return downloadMultipleBills(allBills, billkey, tenantId, locality, isConsolidated, businesService, consumerCode, dispatch);
  ...
  return function generateMultipleBills(_x7, _x8, _x9, _x10, _x11, _x12, _x13) {
...
var getSingleBillData = function getSingleBillData(transformedData) {
  var singleBillData = {
...
var generateSingleBill = exports.generateSingleBill = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(billNo) {
    var state, allBills, billData, data, tenant, transformedData, data1, data2, singleBillData;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            allBills = (0, _get2.default)(state.screenConfiguration, "preparedFinalObject.searchScreenMdmsData.billSearchResponse", []);
            billData = {};
            data = allBills.find(function (item) {
              return (0, _get2.default)(item, "billNumber", "") === billNo;
            });
          ...
          case 7:
            tenant = (0, _get2.default)(data, "tenantId");

            (0, _receiptTransformer.loadUlbLogo)(tenant);
            _context5.next = 11;
            return (0, _receiptTransformer.loadPtBillData)(data);

          case 11:
            transformedData = _context5.sent;
            _context5.next = 14;
          ...
          case 14:
            ...
            billData = (0, _extends3.default)({}, transformedData, {
              ulbLogo: data1
            }, data2);
            singleBillData = getSingleBillData(billData);

            _pdfmake2.default.createPdf(singleBillData).open();
  ...
  return function generateSingleBill(_x14) {
...
var getTaxHeadtable = exports.getTaxHeadtable = function getTaxHeadtable(taxHeads) {
  var taxtableData = taxHeads.reduce(function (acc, item) {
  ...
  taxtableData.billTableWidthForBillDetails = taxHeads.map(function (item) {
    return "*";
  });
  return taxtableData;
};

var getTaxHeadHeaders = function getTaxHeadHeaders(taxHeads) {
  var headers = Object.keys(taxHeads).map(function (item, index) {
    return {
      text: item,
...
var getTaxHeadValues = function getTaxHeadValues(taxHeads) {
  var values = Object.values(taxHeads).map(function (item, index) {
    return {
      text: item,
      border: [false, false, false, false],
...
var getPdfContent = function getPdfContent(transformedData, length, index) {
  return [{
    style: "noc-head",
    table: {
      widths: [60, "*", 120],
    ...
    table: {
      ...
      body: [[{
        ...
        table: {
          ...
          body: [getTaxHeadHeaders(transformedData.taxHeads), getTaxHeadValues(transformedData.taxHeads)]
        },
