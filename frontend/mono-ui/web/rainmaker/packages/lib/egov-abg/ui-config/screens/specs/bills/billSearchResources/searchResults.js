...
var _searchResults = require("../../abg/billSearchResources/searchResults");
    ...
    columns: [{
          ...
          return _react2.default.createElement(
            ...
            { href: "javascript:void(0)",
              onClick: function onClick() {
                (0, _searchResults.billDownload)(tableMeta.rowData[1], tableMeta.rowData[10], tableMeta.rowData[9], tableMeta.rowData[12], tableMeta.rowData[7]);
              }
            },
            value
          );
      ...
      options: {
        ...
        customBodyRender: function customBodyRender(value) {
          return _react2.default.createElement(
            "span",
            null,
            (0, _commons.getLocaleLabels)(value.toUpperCase(), value.toUpperCase())
          );
        }
      ...
      options: {
        ...
        customBodyRender: function customBodyRender(value, tableMeta) {
          return value === "ABG_CANCEL_BILL" ? tableMeta.rowData[4] > 0 ? getActionButton(value, tableMeta) : tableMeta.rowData[4] <= 0 && tableMeta.rowData[13] ? getActionButton(value, tableMeta) : "" : getActionButton(value, tableMeta);
        }
      }
    }, {
  ...
  return _react2.default.createElement(
    ...
    { href: "javascript:void(0)",
      ...
      onClick: function onClick(value) {
        ...
        (0, _commons2.setRoute)("/bills/viewBill?connectionNumber=" + tableMeta.rowData[1] + "&tenantId=" + tableMeta.rowData[10] + "&service=" + service);
      }
    },
    (0, _commons.getLocaleLabels)(value, (0, _commons.getTransformedLocale)("" + value))
  );
};