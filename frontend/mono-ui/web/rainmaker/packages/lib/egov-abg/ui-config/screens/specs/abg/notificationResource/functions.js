      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            isSearchBoxFirstRowValid = (0, _utils.validateFields)("components.div.children.fireNOCApplication.children.cardContent.children.searchContainer.children", state, dispatch, "notification");
            isSearchBoxSecondRowValid = (0, _utils.validateFields)("components.div.children.fireNOCApplication.children.cardContent.children.appStatusAndToFromDateContainer.children", state, dispatch, "notification");
            ...
            if (!(isSearchBoxFirstRowValid && isSearchBoxSecondRowValid)) {
              ...
              try {
                data = response.map(function (item) {
                  ...
                  return _ref2 = {}, (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResults.textToLocalMapping, "Job ID No."), item.jobIdNo || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResults.textToLocalMapping, "Date Created"), (0, _index.convertEpochToDate)(item.dateCreated) || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResults.textToLocalMapping, "Status"), item.status || "-"), (0, _defineProperty3.default)(_ref2, "tenantId", item.tenantId), _ref2;
                });

                dispatch((0, _actions.handleScreenConfigurationFieldChange)("notification", "components.div.children.searchResults", "props.data", data));
                dispatch((0, _actions.handleScreenConfigurationFieldChange)("notification", "components.div.children.searchResults"));
...
var showHideTable = function showHideTable(booleanHideOrShow, dispatch) {
  dispatch((0, _actions.handleScreenConfigurationFieldChange)("notification", "components.div.children.searchResults", "visible", booleanHideOrShow));
};