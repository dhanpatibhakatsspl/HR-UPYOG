...
var textToLocalMapping = exports.textToLocalMapping = {
  "Job ID No.": (0, _get2.default)(getLocalTextFromCode("ABG_COMMON_TABLE_COL_APP_NO"), "message", "Job ID No."),
  "Date Created": (0, _get2.default)(getLocalTextFromCode("ABG_COMMON_TABLE_COL_APP_DATE"), "message", "Date Created"),
  "Status": (0, _get2.default)(getLocalTextFromCode("ABG_COMMON_TABLE_COL_OWN_NAME"), "message", "Status")
  //Download button
};
...
var searchResults = exports.searchResults = {
  ...
  props: {
    // data: [],
    columns: (_columns = {}, (0, _defineProperty3.default)(_columns, (0, _get2.default)(textToLocalMapping, "Job ID No."), {
      format: function format(rowData) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            rowData[(0, _get2.default)(textToLocalMapping, "Job ID No.")]
          )
        );
      }
    }), (0, _defineProperty3.default)(_columns, (0, _get2.default)(textToLocalMapping, "Date Created"), {}), (0, _defineProperty3.default)(_columns, (0, _get2.default)(textToLocalMapping, "Status"), {}), _columns),
    options: {
      filter: false,
      download: false,
      responsive: "stacked",
