      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (payload) {
              dispatch((0, _actions.prepareFinalObject)('applyScreenMdmsData.reasonForReceiptCancel', (0, _get2.default)(payload, 'MdmsRes.common-masters.CancelReceiptReason', [])));
            }
...
var cancelReceipt = {
  ...
  beforeInitScreen: function beforeInitScreen(action, state, dispatch) {
    ...
    (0, _lodash.set)(action.screenConfig, "components.div.children.cancelReceiptDetailsCard.children.cardContent.children.searchContainer.children.reason.props.value", (0, _get2.default)(state.screenConfiguration.preparedFinalObject, 'paymentWorkflows[0].reason', ''));
    (0, _lodash.set)(action.screenConfig, "components.div.children.cancelReceiptDetailsCard.children.cardContent.children.searchContainer.children.addtionalPenalty.props.value", (0, _get2.default)(state.screenConfiguration.preparedFinalObject, 'paymentWorkflows[0].additionalPenalty', ''));
    var additionalDetailsJson = "components.div.children.cancelReceiptDetailsCard.children.cardContent.children.searchContainer.children.addtionalDetails";
    if ((0, _get2.default)(state.screenConfiguration.preparedFinalObject, 'paymentWorkflows[0].reason', '') == "OTHER") {
    ...
    (0, _lodash.set)(action.screenConfig, additionalDetailsJson + ".props.value", (0, _get2.default)(state.screenConfiguration.preparedFinalObject, 'paymentWorkflows[0].additionalDetails', ''));
  ...
  components: {
    div: {
      ...
      children: {
        ...
        cancelReceiptDetailsCard: _cancelReceiptDetails.cancelReceiptDetailsCard,
        cancelReceiptFooter: _cancelReceiptFooter.cancelReceiptFooter
      }
    }
  }
};

exports.default = cancelReceipt;