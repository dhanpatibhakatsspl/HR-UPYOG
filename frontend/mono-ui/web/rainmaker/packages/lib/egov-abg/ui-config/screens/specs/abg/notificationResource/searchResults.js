...
var textToLocalMapping = exports.textToLocalMapping = {
  "Job ID No.": (0, _get2.default)(getLocalTextFromCode("NOC_COMMON_TABLE_COL_APP_NO"), "message", "Job ID No. "),
  "Date Created": (0, _get2.default)(getLocalTextFromCode("NOC_COMMON_TABLE_COL_APP_DATE"), "message", "Date Created"),
  "Status": (0, _get2.default)(getLocalTextFromCode("NOC_COMMON_TABLE_COL_OWN_NAME"), "message", "Status")
