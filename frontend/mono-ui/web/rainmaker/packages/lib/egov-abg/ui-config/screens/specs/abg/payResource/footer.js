...
var getRedirectionURL = exports.getRedirectionURL = function getRedirectionURL(receiptNumber) {
  var redirectionURL = (0, _utils2.ifUserRoleExists)("EMPLOYEE") ? "/abg/acknowledgement?purpose=pay&status=success" : "/inbox";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 23:
            ...
            dispatch((0, _actions2.setRoute)("/uc/acknowledgement?purpose=pay&status=success&receiptNumber=" + receiptNumber));
            _context.next = 32;
            break;
