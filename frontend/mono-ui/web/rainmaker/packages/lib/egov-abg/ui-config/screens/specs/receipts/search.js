...
var getMDMSData = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(action, state, dispatch) {
    var mdmsBody, payload, uiCommonPay;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            uiCommonPay = (0, _get2.default)(payload.MdmsRes, "common-masters.uiCommonPay", []);

            dispatch((0, _actions.prepareFinalObject)("applyScreenMdmsData.businessServices", uiCommonPay && uiCommonPay.filter(function (config) {
              return config.cancelReceipt;
            })));
...
var ucSearchAndResult = {
  ...
  beforeInitScreen: function beforeInitScreen(action, state, dispatch) {
    dispatch((0, _actions.prepareFinalObject)("receiptCancelSearch", {}));
    getData(action, state, dispatch);
    (0, _ucSearch.resetFields)(state, dispatch);
    return action;
  },
  components: {
    div: {
