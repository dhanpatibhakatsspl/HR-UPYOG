...
exports.DownloadIcon = exports.MenuButton = exports.Asteric = exports.AutoSuggest = exports.MapLocation = exports.Checkbox = exports.ApplicationContainer = exports.ApplicationNoContainer = exports.TestAtoms = undefined;
...
var ApplicationContainer = (0, _reactLoadable2.default)({
  loader: function loader() {
...
var DownloadIcon = (0, _reactLoadable2.default)({
  loader: function loader() {
    return import("./DownloadIcon");
  },
  loading: function loading() {
    return _react2.default.createElement(Loading, null);
  }
