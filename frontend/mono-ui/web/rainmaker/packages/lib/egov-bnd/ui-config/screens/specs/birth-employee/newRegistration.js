...
var prepareEditScreenData = function prepareEditScreenData(action, state, dispatch, response) {
  setTimeout(function () {
    if (response.BirthCertificate[0].dateofbirth) {
      dispatch((0, _actions.handleScreenConfigurationFieldChange)("newRegistration", "components.div2.children.details.children.cardContent.children.childInfo.children.cardContent.children.infoOfChild.children.dob", "props.value", (0, _utils2.convertEpochToDateCustom)(response.BirthCertificate[0].dateofbirth)));
    }
    if (response.BirthCertificate[0].dateofreport) {
      dispatch((0, _actions.handleScreenConfigurationFieldChange)("newRegistration", "components.div2.children.details.children.cardContent.children.registrationInfo.children.cardContent.children.registrationInfoCont.children.dateOfReporting", "props.value", (0, _utils2.convertEpochToDateCustom)(response.BirthCertificate[0].dateofreport)));
    }
    if (response.BirthCertificate[0].hospitalname) {
      dispatch((0, _actions.handleScreenConfigurationFieldChange)("newRegistration", "components.div2.children.details.children.cardContent.children.registrationInfo.children.cardContent.children.registrationInfoCont.children.hospitalName", "props.value", response.BirthCertificate[0].hospitalname));
    }
  }, 1);
};
...
var newRegistration = {
  ...
  beforeInitScreen: function beforeInitScreen(action, state, dispatch) {
    ...
    (0, _utils2.loadHospitals)(action, state, dispatch, "birth", (0, _localStorageUtils.getTenantId)()).then(function (response) {
      ...
      if (userAction == "EDIT" && id && module) {
        ...
        (0, _utils2.loadFullCertDetails)(action, state, dispatch, {
          ...
          if (response && response.BirthCertificate && response.BirthCertificate.length > 0) {
            dispatch((0, _actions.prepareFinalObject)("bnd.birth.newRegistration", response.BirthCertificate[0]));
            dispatch((0, _actions.prepareFinalObject)("bnd.birth.newRegistration.isLegacyRecord", response.BirthCertificate[0].isLegacyRecord));
            prepareEditScreenData(action, state, dispatch, response);
          }
        });
      } else {
        dispatch((0, _actions.prepareFinalObject)("bnd.birth.newRegistration", {
          birthFatherInfo: {},
          birthMotherInfo: {},
          birthPresentaddr: {},
          birthPermaddr: {}
