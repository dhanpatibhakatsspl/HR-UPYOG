...
var _birthSearchCard = require("./birthSearchResources/birthSearchCard");

var _searchResults = require("./birthSearchResources/searchResults");

require("./birthSearchResources/index.css");
  ...
  beforeInitScreen: function beforeInitScreen(action, state, dispatch) {
    (0, _utils2.loadMdmsData)(action, state, dispatch).then(function (response) {
      ...
      if (!(process.env.REACT_APP_NAME === "Citizen")) {
        ...
        (0, _lodash.set)(action.screenConfig, "components.div.children.birthSearchCard.children.cardContent.children.searchContainerCommon.children.cantonmentSelect.props.isDisabled", true);
        (0, _lodash.set)(action.screenConfig, "components.div.children.birthSearchCard.children.cardContent.children.searchContainerCommon.children.gender.props.required", false);
        (0, _lodash.set)(action.screenConfig, "components.div.children.birthSearchCard.children.cardContent.children.searchContainerCommon.children.gender.required", false);
      }
  ...
  components: {
    div: {
      ...
      children: {
        headerDiv: {
          ...
          children: {
            ...
            groupBillButton: {
              ...
              visible: process.env.REACT_APP_NAME !== "Citizen" && (0, _utils2.ifUserRoleExists)("BIRTH_APPLICATION_CREATOR"),
              props: {
                variant: "contained",
                color: "primary",
                style: {
              ...
              onClickDefination: {
                action: "page_change",
                path: process.env.REACT_APP_SELF_RUNNING === "true" ? "/egov-ui-framework/birth-employee/newRegistration" : "/birth-employee/newRegistration"
              }
            },
            howitWorksButton: {
              componentPath: "Button",
        ...
        birthSearchCard: _birthSearchCard.birthSearchCard,
