...
exports.getFullBirthCertDetailsCard = exports.getAddressForm = exports.getPersonDetailsForm = undefined;
...
var getPersonDetailsForm = exports.getPersonDetailsForm = function getPersonDetailsForm(type, inJsonPath) {
  return (0, _utils.getCommonContainer)({
    ...
    education: (0, _utils.getLabelWithValue)({
    ...
    profession: (0, _utils.getLabelWithValue)({
...
var getFullBirthCertDetailsCard = exports.getFullBirthCertDetailsCard = function getFullBirthCertDetailsCard(inJsonPath) {
    ...
    editButton: {
      ...
      onClickDefination: {
        ...
        callBack: function callBack(state, dispatch) {
          ...
          var applyUrl = "/birth-employee/newRegistration?action=EDIT&certificateId=" + id + "&module=birth";
