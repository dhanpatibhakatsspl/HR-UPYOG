  ...
  return _react2.default.createElement(
    "a",
    {
      ...
      onClick: function onClick(value) {
        var tenantId = tableMeta.rowData[8];
        var id = tableMeta.rowData[0];
        var action = tableMeta.rowData[7];
        var businessService = tableMeta.rowData[9];

        _store2.default.dispatch((0, _actions.prepareFinalObject)("bnd.birth.download.certificateId", id));
        _store2.default.dispatch((0, _actions.prepareFinalObject)("bnd.birth.download.tenantId", tenantId));
        _store2.default.dispatch((0, _actions.prepareFinalObject)("bnd.birth.download.businessService", businessService));

        (0, _birthSearchCard.showHideConfirmationPopup)(_store2.default.getState(), _store2.default.dispatch, "getCertificate");
      }
    },
  ...
  return _react2.default.createElement(
    "a",
    {
      ...
      onClick: function onClick(value) {
        var id = tableMeta.rowData[0];
        var tenantId = tableMeta.rowData[8];
        var url = "/employee/bnd-common/fullViewCertificate?tenantId=" + tenantId + "&certificateId=" + id + "&module=birth";
