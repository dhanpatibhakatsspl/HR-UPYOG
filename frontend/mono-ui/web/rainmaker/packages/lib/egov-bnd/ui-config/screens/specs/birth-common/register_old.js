    ...
    mihyRegisterGrid: {
      ...
      children: {
        ...
        mihyRegisterItem: {
          ...
          children: {
            mihyRegisterCard: (0, _utils.getCommonCardWithHeader)({
              mihyloginDiv: {
                uiFramework: "custom-atoms",
                componentPath: "Div",
                props: {
                ...
                children: {
                  ...
                  mihyRegisterButton: {
                    ...
                    children: {
                      mihyRegisterButtonText: (0, _utils.getLabel)({ label: "Let's go" })
                      // onClickDefination:{
                      //   action:"submit",
                      //   method:"get",
                      //   endPoint:"afbc.com",
              ...
              mihyRegisterHeader: {
                ...
                children: {
                  mihyRegisterHeaderText: (0, _utils.getLabel)({ label: "Register" })
                },
                props: {
                  align: "center",
                  variant: "title",
