...
exports.deathSearchCard = exports.buttonContainer = exports.searchSet2 = exports.searchSet1 = exports.searchSetCommon = exports.showHideConfirmationPopup = undefined;
...
var resetFields = function resetFields(state, dispatch) {
  ...
  var componentPath = "components.div.children.deathSearchCard.children.cardContent.children.searchContainer2.children.details.children";
  ...
  dispatch((0, _actions.prepareFinalObject)("bnd.death.deathSearchResponse", []));
...
var cbChanged = function cbChanged(action, state, dispatch) {
  var tenantId = (0, _get2.default)(state.screenConfiguration.preparedFinalObject.bnd.death, "tenantId");
...
var setVisibilityOptionsSet1 = function setVisibilityOptionsSet1(state, dispatch, visible) {
  dispatch((0, _actions.handleScreenConfigurationFieldChange)("getCertificate", "components.div.children.deathSearchCard.children.cardContent.children.searchContainer1", "visible", visible));
};

var setVisibilityOptionsSet2 = function setVisibilityOptionsSet2(state, dispatch, visible) {
  dispatch((0, _actions.handleScreenConfigurationFieldChange)("getCertificate", "components.div.children.deathSearchCard.children.cardContent.children.searchContainer2", "visible", visible));
};

var showHideConfirmationPopup = exports.showHideConfirmationPopup = function showHideConfirmationPopup(state, dispatch) {
  var toggle = (0, _get2.default)(state.screenConfiguration.screenConfig["getCertificate"], "components.div.children.deathSearchCard.children.cardContent.children.disclaimerDialog.props.open", false);
  dispatch((0, _actions.handleScreenConfigurationFieldChange)("getCertificate", "components.div.children.deathSearchCard.children.cardContent.children.disclaimerDialog", "props.open", !toggle));
};
...
var searchSet2 = exports.searchSet2 = (0, _utils.getCommonContainer)({
  nameOfPerson: (0, _utils.getTextField)({
    label: {
      labelName: "Name",
  ...
  spouseName: (0, _utils.getTextField)({
    label: {
...
var deathSearchCard = exports.deathSearchCard = (0, _utils.getCommonCard)({
