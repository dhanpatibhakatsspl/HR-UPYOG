...
function FeesEstimateCard(props) {
  ...
  var isPaid = estimate.fees.payStatus;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "div",
        { style: { marginTop: 48, maxWidth: 600 } },
        _react2.default.createElement(
          _Grid2.default,
          { container: true },
          estimate.fees.map(function (fee, key) {
            var tooltip = fee.info ? _react2.default.createElement(_uiMolecules.Tooltip, { val: fee.info, icon: "info_circle" }) : "";
