...
var _DocumentList = require("../../ui-molecules-local/DocumentList");
...
var DocumentListContainer = function (_Component) {
  ...
  (0, _createClass3.default)(DocumentListContainer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_DocumentList2.default, (0, _extends3.default)({ uploadedDocsInRedux: uploadedDocuments }, rest));
    }
  }]);
...
var mapStateToProps = function mapStateToProps(state) {
  ...
  var documents = (0, _get2.default)(screenConfiguration.preparedFinalObject, "LicensesTemp[0].applicationDocuments", []);
  ...
  var _ref = screenConfiguration || {},
      preparedFinalObject = _ref.preparedFinalObject;

  return { documents: documents, tenantId: tenantId, uploadedDocuments: uploadedDocuments, preparedFinalObject: preparedFinalObject };
};
