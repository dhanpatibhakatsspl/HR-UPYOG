...
var getMultiItem = function getMultiItem(billingslabData, classes, style) {
  ...
  return billingslabData.map(function (item, index) {
    if (item.type === "trade") labelCategory = "TRADETYPE";else if (item.type = "accessories") labelCategory = "ACCESSORIESCATEGORY";
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_uiContainers.LabelContainer, {
          labelKey: "TRADELICENSE_" + labelCategory + "_" + item.category.toUpperCase().replace(/[.:-\s\/]/g, "_"),
          style: {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_uiAtoms.Label, {
          label: labelCategory === "TRADETYPE" ? "Rs " + item.rate : "Rs " + item.total,
          style: {
...
var ViewBreakupContainer = function (_React$Component) {
  ...
  function ViewBreakupContainer() {
    ...
    }, _this.getRebatePenalty = function (label, total, classes, style) {
      return _react2.default.createElement(
        _Grid2.default,
        { sm: 12, className: classes.container, container: true },
        _react2.default.createElement(
  ...
  (0, _createClass3.default)(ViewBreakupContainer, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          estimateCardData = _props.estimateCardData;

      var RebateArray = estimateCardData && estimateCardData.length > 1 && estimateCardData.filter(function (item) {
        return item.name.labelKey === "TL_RENEWAL_REBATE";
      });
      var PenaltyArray = estimateCardData && estimateCardData.length > 1 && estimateCardData.filter(function (item) {
        return item.name.labelKey === "TL_RENEWAL_PENALTY";
      });
      var RebateTotal = RebateArray && (0, _get2.default)(RebateArray[0], "value", 0);
      var PenaltyTotal = PenaltyArray && (0, _get2.default)(PenaltyArray[0], "value", 0);
      var style = this.state.style;
      var getGridItem = this.getGridItem,
          handleClose = this.handleClose;

      var totalBill = tradeTotal + accessoriesTotal + RebateTotal + PenaltyTotal;
      return _react2.default.createElement(_Dialog2.default, {
        ...
        children: [accessoriesTotal > 0 || tradeTotal > 0 ? _react2.default.createElement(
          ...
          RebateArray && RebateArray.length > 0 && this.getRebatePenalty("TL_RENEWAL_REBATE", RebateTotal, classes, style),
          PenaltyArray && PenaltyArray.length > 0 && this.getRebatePenalty("TL_RENEWAL_PENALTY", PenaltyTotal, classes, style),
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var estimateCardData = (0, _get2.default)(preparedFinalObject, "LicensesTemp[0].estimateCardData");
  ...
  return {
    ...
    estimateCardData: estimateCardData
  };
};
