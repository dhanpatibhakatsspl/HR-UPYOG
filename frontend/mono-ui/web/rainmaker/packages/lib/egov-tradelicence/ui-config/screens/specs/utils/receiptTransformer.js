...
exports.loadReceiptGenerationData = exports.loadUserNameData = exports.loadMdmsData = exports.loadReceiptData = exports.loadApplicationData = exports.loadUlbLogo = exports.getMessageFromLocalization = undefined;
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (response && response.Payments && response.Payments.length > 0) {
              ...
              response.Payments[0].paymentDetails[0].bill.billDetails[0].billAccountDetails.map(function (item) {
