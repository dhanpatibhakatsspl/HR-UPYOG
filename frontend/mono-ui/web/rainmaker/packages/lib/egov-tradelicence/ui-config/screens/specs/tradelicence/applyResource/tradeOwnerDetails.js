...
exports.tradeOwnerDetails = exports.ownerInfoInstitutional = exports.OwnerInfoCard = exports.getRelationshipRadioButton = exports.getFatherNameField = exports.getOwnerEmailField = exports.getOwnerDOBField = exports.getOwnerGenderField = exports.getOwnerMobNoField = undefined;
...
var OwnerInfoCard = exports.OwnerInfoCard = {
  uiFramework: "custom-containers",
  ...
  props: {
    scheama: (0, _utils.getCommonGrayCard)({
      ...
      tradeUnitCardContainer: (0, _utils.getCommonContainer)({
        getOwnerMobNoField: (0, _utils.getTextField)({
          label: {
            labelName: "Mobile No.",
            labelKey: "TL_NEW_OWNER_DETAILS_MOB_NO_LABEL"
          },
        ...
        getFatherNameField: (0, _utils.getTextField)({
          label: {
            labelName: "Father/Spouse Name",
            labelKey: "TL_NEW_OWNER_DETAILS_FATHER_NAME_LABEL"
          },
        ...
        getOwnerEmailField: (0, _utils.getTextField)({
          label: {
            labelName: "Email",
            labelKey: "TL_NEW_OWNER_DETAILS_EMAIL_LABEL"
          },
...
var ownerInfoInstitutional = exports.ownerInfoInstitutional = (0, _extends3.default)({}, (0, _utils.getCommonGrayCard)({
  ...
  tradeUnitCardContainerInstitutional: (0, _utils.getCommonContainer)({
    getOwnerMobNoField: (0, _utils.getTextField)({
      label: {
        labelName: "Mobile No.",
        labelKey: "TL_NEW_OWNER_DETAILS_MOB_NO_LABEL"
    ...
    getOwnerGenderField: (0, _utils.getSelectField)({
      label: {
        labelName: "Gender",
        labelKey: "TL_NEW_OWNER_DETAILS_GENDER_LABEL"
      },
...
var ownerShipChange = function ownerShipChange(reqObj) {
  try {
    var value = reqObj.value,
...
var subOwnerShipChange = function subOwnerShipChange(reqObj) {
  try {
    var value = reqObj.value,
        dispatch = reqObj.dispatch,
        state = reqObj.state;
    ...
    dispatch((0, _actions.prepareFinalObject)("Licenses[0].tradeLicenseDetail.subOwnerShipCategory", value));
  } catch (e) {
    console.log(e);
  }
};
  ...
  ownershipType: (0, _utils.getCommonContainer)({
    dynamicMdmsOwnerShip: {
      ...
      props: {
        ...
        callBackEdit: _utils2.updateOwnerShipEdit
      }
    }
