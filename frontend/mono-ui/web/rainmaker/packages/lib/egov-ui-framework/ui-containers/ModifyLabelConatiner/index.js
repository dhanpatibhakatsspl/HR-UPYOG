...
var LabelContainer = function (_React$Component) {
	...
	(0, _createClass3.default)(LabelContainer, [{
		...
		value: function render() {
			...
			var fieldLabel = typeof fieldValue === "string" ? (0, _commons.getLocaleLabels)(fieldValue, localePrefix && localePrefix.moduleName ? (0, _commons.appendModulePrefix)(fieldValue, localePrefix) : fieldValue, localizationLabels) : fieldValue;

			var lebelName = translatedLabel;

			var labelValue = fieldValue ? fieldLabel : fieldValue;
			...
			var classname = isMode === "MODIFY" && isVisibleLabel && labelValue && labelValue !== "NA" ? "show-label" : "hide-label";
...
var mapStateToProps = function mapStateToProps(state, ownprops) {
	...
	if (jsonPath) {
		...
		var newfieldValue = (0, _get2.default)(preparedFinalObject, jsonPath.replace('Old', ''));
