  ...
  function DialogContainer() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DialogContainer.__proto__ || Object.getPrototypeOf(DialogContainer)).call.apply(_ref, [this].concat(args))), _this), _this.handleClose = function () {
      var _this$props = _this.props,
          ...
          _this$props$reRouteUR = _this$props.reRouteURL,
          reRouteURL = _this$props$reRouteUR === undefined ? '/' : _this$props$reRouteUR;

      _this.props.handleField(screenKey, "components.adhocDialog", "props.open", false);
      if ((0, _commons.getQueryArg)(window.location.href, "action") === 'showRequiredDocuments' ? true : false) {
        _this.props.setRoute(reRouteURL);
      };
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  open = open || (0, _commons.getQueryArg)(window.location.href, "action") === 'showRequiredDocuments' ? true : false;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return { handleField: function handleField(a, b, c, d) {
    ...
    setRoute: function setRoute(url) {
      return dispatch((0, _actions2.setRoute)(url));
    }
  };
};
