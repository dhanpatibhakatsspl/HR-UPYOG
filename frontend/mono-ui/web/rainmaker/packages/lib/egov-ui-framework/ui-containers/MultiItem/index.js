...
var MultiItem = function (_React$Component) {
  ...
  function MultiItem() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MultiItem.__proto__ || Object.getPrototypeOf(MultiItem)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
      ...
      var _this$props = _this.props,
          ...
          onMultiItemAdd = _this$props.onMultiItemAdd;
      ...
      if (sourceJsonPath) {
        ...
        for (var variable in multiItemContent) {
          ...
          } else if (multiItemContent.hasOwnProperty(variable) && multiItemContent[variable].props && multiItemContent[variable].props.jsonPath) {
        ...
        if (onMultiItemAdd) {
          multiItemContent = onMultiItemAdd(_this.props.state, multiItemContent);
        }
    ...
    }, _this.checkDisableDelete = function (disableDeleteIfKeyExists, preparedFinalObject, sourceJsonPath, key) {
      if (disableDeleteIfKeyExists && (0, _get2.default)(preparedFinalObject, sourceJsonPath + "[" + key + "]." + disableDeleteIfKeyExists)) {
        return false;
      }
      return true;
  ...
  (0, _createClass3.default)(MultiItem, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      } else if (!(0, _isEqual2.default)((0, _get2.default)(nextProps, "preparedFinalObject." + nextProps.sourceJsonPath, []), (0, _get2.default)(this.props, "preparedFinalObject." + this.props.sourceJsonPath, []))) {
        this.initMultiItem(nextProps);
      } else if ((0, _get2.default)(nextProps, "preparedFinalObject." + nextProps.sourceJsonPath, []) && (0, _get2.default)(this.props, "items", []) && (0, _get2.default)(nextProps, "preparedFinalObject." + nextProps.sourceJsonPath, []).length !== (0, _get2.default)(this.props, "items", []).length) {
        this.initMultiItem(nextProps);
      }
    }
    ...
    value: function render() {
      var _props = this.props,
          ...
          disableDeleteIfKeyExists = _props.disableDeleteIfKeyExists,
          preparedFinalObject = _props.preparedFinalObject,
          sourceJsonPath = _props.sourceJsonPath;
      var addItem = this.addItem,
          removeItem = this.removeItem,
          checkDisableDelete = this.checkDisableDelete;

      var _ref2 = addItemLabel || "",
        ...
        items.length > 0 && items.map(function (item, key) {
          if (checkActiveItem(item)) {
            return _react2.default.createElement(
              _Div2.default,
              { key: key },
              checkActiveItems(items) > 1 && !isReviewPage && checkDisableDelete(disableDeleteIfKeyExists, preparedFinalObject, sourceJsonPath, key) && _react2.default.createElement(
                _Container2.default,
                null,
        ...
        hasAddItem !== false && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { onClick: function onClick(e) {
                  return addItem();
                }, color: "primary", className: "sss" },
              _react2.default.createElement(_Icon2.default, { iconName: "add" }),
              _react2.default.createElement(_LabelContainer2.default, { labelName: labelName, labelKey: labelKey })
            )
          )
        )
      );
