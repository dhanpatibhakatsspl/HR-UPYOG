...
var _remoteConfigPaths = require("ui-config/commonConfig/remote-config-paths");

var _remoteConfigPaths2 = _interopRequireDefault(_remoteConfigPaths);
...
var screenHoc = function screenHoc(_ref) {
  var _ref$path = _ref.path,
      ...
      rest = (0, _objectWithoutProperties3.default)(_ref, ["path", "screenKey", "hasOwnConfig", "screenConfig", "hasRemoteConfig", "moduleName"]);
  return function (Screen) {
      ...
      function ScreenWrapper(props) {
        ...
        try {
          if (hasOwnConfig) {
            ...
            // });
            _this.screenConfig = (0, _remoteConfigPaths2.default)(path, screenKey);
          } else {
            _this.screenConfig = (0, _remoteConfigPaths2.default)(path, screenKey);
          }
    ...
    var mapStateToProps = function mapStateToProps(state) {
      ...
      var screenConfig = screenConfiguration.screenConfig,
          ...
          toastObject = screenConfiguration.toastObject,
          spinner = screenConfiguration.spinner;

      return { screenConfig: screenConfig, preparedFinalObject: preparedFinalObject, state: state, toastObject: toastObject, spinner: spinner };
    };
