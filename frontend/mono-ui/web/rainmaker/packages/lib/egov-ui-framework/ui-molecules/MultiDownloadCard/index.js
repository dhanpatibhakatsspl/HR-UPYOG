...
function MultiCardDownloadGrid(props) {
  ...
  return _react2.default.createElement(
    ...
    data && data.length > 0 && data.map(function (item, key) {
      var linkText = "CS_" + (item.linkText && item.linkText.toUpperCase() || "NA");
      return _react2.default.createElement(
        _Grid2.default,
        {
          item: true,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_uiContainers.LabelContainer, { labelName: linkText, labelKey: linkText })
            )
          )
        )
      );
