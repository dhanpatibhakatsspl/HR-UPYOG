...
var getModuleName = exports.getModuleName = function getModuleName(pathName, BPAtradeType) {
  if (pathName && pathName.includes("fire-noc")) {
    return "FIRENOC";
  } else if (pathName && pathName.includes("egov-bpa")) {
    var moduleServiceName = "BPA";
    ...
    return "BPA_OC";
  } else if (pathName && pathName.includes("tradelicence") || pathName && pathName.includes("tradelicense")) {
    return "NewTL";
