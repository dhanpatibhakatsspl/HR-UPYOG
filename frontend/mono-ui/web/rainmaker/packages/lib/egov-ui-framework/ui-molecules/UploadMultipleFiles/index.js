...
var UploadMultipleFiles = function (_Component) {
  ...
  function UploadMultipleFiles() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = UploadMultipleFiles.__proto__ || Object.getPrototypeOf(UploadMultipleFiles)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var documents = _this.props.documents;

      documents && Array.isArray(documents) && _this.setState({ documents: documents });
  ...
  (0, _createClass3.default)(UploadMultipleFiles, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        null,
        documents && Array.isArray(documents) && documents.map(function (document, index) {
          return _react2.default.createElement(
            "div",
            { style: { marginTop: 10 }, key: index },
            _react2.default.createElement(_uiAtoms.UploadedDocument, {
              document: document,
...
var mapStateToProps = function mapStateToProps(state, ownprops) {
  ...
  var documents = (0, _get2.default)(state.screenConfiguration.preparedFinalObject, jsonPath);
...
exports.default = (0, _styles.withStyles)(styles)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(UploadMultipleFiles));