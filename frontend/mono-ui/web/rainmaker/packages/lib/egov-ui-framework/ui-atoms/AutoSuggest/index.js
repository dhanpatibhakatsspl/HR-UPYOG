...
var getSuggestions = function getSuggestions(suggestions, defaultSort) {

  var result = suggestions && suggestions.length > 0 && Array.isArray(suggestions) && suggestions.map(function (suggestion) {
    return {
      value: suggestion.code,
      label: suggestion.name
    };
  }) || [];
  return defaultSort ? result && Array.isArray(result) && result.sort(_commons.sortDropdownLabels) : result;
};
    ...
    value: function render() {
      var _props = this.props,
        ...
        shrink: true
          ...
          rest = (0, _objectWithoutProperties3.default)(_props, ["classes", "theme", "suggestions", "label", "placeholder", "fullwidth", "required", "value", "className", "defaultSort", "disabled", "inputLabelProps"]);
