...
var _appConfig = require("../../ui-config/app-config");
...
var MapLocation = compose(withProps({
  googleMapURL: "https://maps.googleapis.com/maps/api/js?key=" + _appConfig.MAP_API_KEY + "&v=3.exp&libraries=geometry,drawing,places",
