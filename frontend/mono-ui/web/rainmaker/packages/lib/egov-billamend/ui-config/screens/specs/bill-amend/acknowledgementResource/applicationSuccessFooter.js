...
exports.applicationSuccessFooter = exports.generatePdfAndDownload = undefined;
...
var generatePdfAndDownload = exports.generatePdfAndDownload = function generatePdfAndDownload(state, dispatch, action, applicationNumber, tenant) {
    ...
    downloadFormButton: {
      ...
      children: {
        downloadFormButtonLabel: (0, _utils.getLabel)({
          ...
          labelKey: "BILL_APPLICATION_BUTTON_DOWN_CONF"
        })
      },
      onClickDefination: {
        action: "condition",
    ...
    printFormButton: {
      ...
      children: {
        printFormButtonLabel: (0, _utils.getLabel)({
          ...
          labelKey: "BILL_APPLICATION_BUTTON_PRINT_CONF"
        })
      },
      onClickDefination: {
        action: "condition",
