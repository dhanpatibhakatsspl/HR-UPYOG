...
var _commons2 = require("../../../utils/commons");
...
var CityPickerDialog = function (_Component) {
  ...
  function CityPickerDialog() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CityPickerDialog.__proto__ || Object.getPrototypeOf(CityPickerDialog)).call.apply(_ref, [this].concat(args))), _this), _this.state = { results: [], searchTerm: "", open: false }, _this.componentDidMount = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
    ...
    })), _this.getLocalizedLabel = function (label) {
      var localizationLabels = _this.props.localizationLabels;

      return (0, _commons2.getTranslatedLabel)(label, localizationLabels);
      ...
      results = results.map(function (result, index) {
        ...
        mappedResult.primaryText = _this.getLocalizedLabel("TENANT_TENANTS_" + result.key.toUpperCase().replace(/[.:-\s\/]/g, "_"));
      ...
      if (searchTerm) {
        ...
        _this.setState({ results: filteredCities, searchTerm: searchTerm });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_components.TextFieldIcon, (0, _extends3.default)({}, field, {
            ...
            value: (0, _commons.getCityNameByCode)((field || {}).value, localizationLabels),
            id: "person-city",
            iconPosition: "after",
        ...
        _react2.default.createElement(
          _components.Dialog,
          {
            ...
            title: _react2.default.createElement(_translationNode2.default, { label: "CS_SELECT_CITY_CHOOSE_CITY", fontSize: "16px", bold: true, color: "#484848", containerStyle: { padding: "20px 10px", backgroundColor: "#fff" } }),
            modal: false,
            open: open,
          ...
          _react2.default.createElement(_components.AutoSuggest, {
            ...
            dataSource: cities,
            searchInputText: _react2.default.createElement(_translationNode2.default, { label: "ACTION_TEST_SEARCH", color: "#727272", labelStyle: { display: "flex", justifyContent: "left" } }),
            searchKey: "text",
            autoFocus: true,
...
var mapStateToProps = function mapStateToProps(state) {
  ...
  var localizationLabels = (0, _get2.default)(state.app, "localizationLabels", {});
  return { cities: cities, localizationLabels: localizationLabels };
};
