...
exports.DisableBackComponent = exports.AutoSuggest = exports.Switch = exports.MenuButton = exports.Asteric = exports.MapLocation = exports.UploadedDocument = exports.Checkbox = exports.UploadFile = exports.ApplicationNoContainer = exports.TestAtoms = undefined;
...
var DisableBackComponent = (0, _reactLoadable2.default)({
  loader: function loader() {
    return import("./DisableBackComponent");
  },
  loading: function loading() {
    return _react2.default.createElement(Loading, null);
  }
...
exports.DisableBackComponent = DisableBackComponent;