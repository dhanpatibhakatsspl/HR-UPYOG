        ...
        switch (_context.prev = _context.next) {
          ...
          case 23:
            ...
            if (status === 400 && data === "") {
              ...
              apiError = data.hasOwnProperty("Errors") && data.Errors && data.Errors.length && data.Errors[0].code || data.hasOwnProperty("error") && data.error.fields && data.error.fields.length && data.error.fields[0].message || data.hasOwnProperty("error_description") && data.error_description || apiError;
            }
            _store2.default.dispatch((0, _actions.toggleSpinner)());
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 19:
            ...
            _store2.default.dispatch((0, _actions.toggleSpinner)());
            _store2.default.dispatch((0, _actions.toggleSnackbar)(true, { labelName: _context4.t0.message, labelKey: _context4.t0.message }, "error"));
