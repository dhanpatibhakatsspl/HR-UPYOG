...
exports.ActivateEmployee = exports.deactivateEmployee = undefined;
...
var deactivateEmployeeCallback = function deactivateEmployeeCallback(state, dispatch) {
  var employeeStatus = (0, _lodash.get)(state.screenConfiguration.preparedFinalObject, 'employeeStatus', 'DEACTIVATE');
  (0, _functions.createUpdateEmployee)(state, dispatch, employeeStatus);
};
var activateEmployeeCallback = function activateEmployeeCallback(state, dispatch) {
  (0, _functions.createUpdateEmployee)(state, dispatch, "ACTIVATE");
};

var deactivateEmployee = exports.deactivateEmployee = (0, _utils.getCommonContainer)({
  ...
  body: {
    ...
    componentPath: "Container",
    children: {
      deactivationReason: (0, _utils.getSelectField)({
        label: {
      ...
      effectiveDate: (0, _utils.getDateField)({
        label: {
...
var ActivateEmployee = exports.ActivateEmployee = (0, _utils.getCommonContainer)({
  header: {
    uiFramework: "custom-atoms",
    componentPath: "Container",
    props: {
