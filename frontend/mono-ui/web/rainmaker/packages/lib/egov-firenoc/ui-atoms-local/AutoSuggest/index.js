...
var getSuggestions = function getSuggestions(suggestions, defaultSort) {
  suggestions = suggestions && suggestions.length > 0 && suggestions.map(function (suggestion) {
    return {
      value: suggestion.code,
      label: suggestion.name
    };
  });
  suggestions = defaultSort && suggestions && Array.isArray(suggestions) ? suggestions.sort(_commons.sortDropdownLabels) : suggestions || [];
  return suggestions;
};
    ...
    value: function render() {
      var _props = this.props,
        ...
        shrink: true
          ...
          rest = (0, _objectWithoutProperties3.default)(_props, ["classes", "theme", "suggestions", "label", "placeholder", "fullwidth", "required", "value", "defaultSort", "className", "inputLabelProps"]);
