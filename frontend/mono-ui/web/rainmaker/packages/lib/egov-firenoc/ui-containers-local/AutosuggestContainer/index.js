  ...
  (0, _createClass3.default)(AutoSuggestor, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = (0, _objectWithoutProperties3.default)(_props, ["value", "preparedFinalObject", "label", "placeholder", "suggestions", "className", "localizationLabels", "labelsFromLocalisation", "localePrefix", "defaultSort"]);
      ...
      if (labelsFromLocalisation) {
        suggestions = getLocalisedSuggestions(JSON.parse(JSON.stringify(suggestions)), localePrefix, localizationLabels, defaultSort);
      }
...
var getLocalisedSuggestions = function getLocalisedSuggestions(suggestions, localePrefix, transfomedKeys, defaultSort) {
  suggestions = suggestions && Array.isArray(suggestions) && suggestions.length > 0 && suggestions.map(function (option, key) {
  ...
  suggestions = defaultSort && suggestions && Array.isArray(suggestions) ? suggestions.sort(_commons.sortDropdownNames) : suggestions || [];
  return suggestions;
};
