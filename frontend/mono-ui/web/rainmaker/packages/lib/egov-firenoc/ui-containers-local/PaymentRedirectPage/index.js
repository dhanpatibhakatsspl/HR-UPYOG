...
var PaymentRedirect = function (_Component) {
  ...
  function PaymentRedirect() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PaymentRedirect.__proto__ || Object.getPrototypeOf(PaymentRedirect)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var search, pgUpdateResponse, consumerCode, tenantId, response, transactionId;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _this.props.setRoute("/fire-noc/acknowledgement?purpose=" + "pay" + "&status=" + "failure" + "&applicationNumber=" + consumerCode + "&tenantId=" + tenantId);
              _context.next = 20;
              break;
            ...
            case 17:
              ...
              _this.props.setRoute("/fire-noc/acknowledgement?purpose=" + "pay" + "&status=" + "success" + "&applicationNumber=" + consumerCode + "&tenantId=" + tenantId + "&secondNumber=" + transactionId);
...
exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)((0, _reactRouterDom.withRouter)(PaymentRedirect));