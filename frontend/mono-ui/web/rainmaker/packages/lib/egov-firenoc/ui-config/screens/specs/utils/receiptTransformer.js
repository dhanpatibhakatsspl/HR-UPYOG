...
exports.loadPdfGenerationData = exports.loadUserNameData = exports.loadMdmsData = exports.loadReceiptData = exports.loadApplicationData = exports.loadUlbLogo = exports.getMessageFromLocalization = undefined;
...
var getMessageFromLocalization = exports.getMessageFromLocalization = function getMessageFromLocalization(code) {
  var messageObject = JSON.parse((0, _localStorageUtils.getLocalization)("localization_" + localStorage.getItem("locale"))) && JSON.parse((0, _localStorageUtils.getLocalization)("localization_" + localStorage.getItem("locale"))).find(function (item) {
            ...
            if (response && response.FireNOCs && response.FireNOCs.length > 0) {
              ...
              data.owners = owners.map(function (owner) {
                return {
                  ...
                  relationship: (0, _get2.default)(owner, "relationship", "NA"),
              ...
              // Institution Details
              data.ownershipType = nullToNa((0, _get2.default)(response, "FireNOCs[0].fireNOCDetails.applicantDetails.ownerShipType", "NA"));
              data.institutionName = nullToNa((0, _get2.default)(response, "FireNOCs[0].fireNOCDetails.applicantDetails.additionalDetail.institutionName", "NA"));
              data.telephoneNumber = nullToNa((0, _get2.default)(response, "FireNOCs[0].fireNOCDetails.applicantDetails.additionalDetail.telephoneNumber", "NA"));
              data.institutionDesignation = nullToNa((0, _get2.default)(response, "FireNOCs[0].fireNOCDetails.applicantDetails.additionalDetail.institutionDesignation", "NA"));
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (response && response.Payments && response.Payments.length > 0) {
              data.receiptNumber = nullToNa((0, _get2.default)(response, "Payments[0].paymentDetails[0].receiptNumber", "NA"));
              data.amountPaid = (0, _get2.default)(response, "Payments[0].paymentDetails[0].totalAmountPaid", 0);
              data.totalAmount = (0, _get2.default)(response, "Payments[0].paymentDetails[0].totalDue", 0);
              data.amountDue = data.totalAmount - data.amountPaid;
              data.paymentMode = nullToNa((0, _get2.default)(response, "Payments[0].paymentMode", "NA"));
              data.transactionNumber = nullToNa((0, _get2.default)(response, "Payments[0].transactionNumber", "NA"));
              data.bankName = (0, _get2.default)(response, "Payments[0].bankName", "NA");
              data.branchName = (0, _get2.default)(response, "Payments[0].branchName", null);
              data.bankAndBranch = nullToNa(data.bankName && data.branchName ? data.bankName + ", " + data.branchName : (0, _get2.default)(data, "bankName", "NA"));
              data.paymentDate = nullToNa(epochToDate((0, _get2.default)(response, "Payments[0].transactionDate", 0)));
              data.g8ReceiptNo = nullToNa((0, _get2.default)(response, "Payments[0].paymentDetails[0].manualReceiptNumber", "NA"));
              data.g8ReceiptDate = nullToNa(epochToDate((0, _get2.default)(response, "Payments[0].paymentDetails[0].manualReceiptDate", 0)));
              /** START NOC Fee, Adhoc Penalty/Rebate Calculation */
              nocAdhocPenalty = 0, nocAdhocRebate = 0;

              response.Payments[0] && response.Payments[0].paymentDetails[0] && response.Payments[0].paymentDetails[0].bill && response.Payments[0].paymentDetails[0].bill.billDetails[0] && response.Payments[0].paymentDetails[0].bill.billDetails[0].billAccountDetails && response.Payments[0].paymentDetails[0].bill.billDetails[0].billAccountDetails.map(function (item) {
...
var loadMdmsData = exports.loadMdmsData = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(tenantId) {
    var localStorageLabels, localizationLabels, data, mdmsBody, response, ulbData, ulbGrade, cityKey;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return (0, _utils.searchMdmsData)(mdmsBody);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 4;
            return (0, _commons.getUserDataFromUuid)(bodyObject);
