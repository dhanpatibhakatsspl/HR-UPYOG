    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0, _commons2.disableField)('summary', "components.div.children.footer.children.submitButton", dispatch);
            _context.next = 3;
          ...
          case 3:
            ...
            if ((0, _get2.default)(response, "status", "") === "success") {
              (0, _commons2.enableField)('summary', "components.div.children.footer.children.submitButton", dispatch);
