        ...
        switch (_context.prev = _context.next) {
          ...
          case 21:
            ...
            data = response.FireNOCs.map(function (item) {
              ...
              return _ref2 = {}, (0, _defineProperty3.default)(_ref2, 'TL_COMMON_TABLE_COL_APP_NO', item.fireNOCDetails.applicationNumber || "-"), (0, _defineProperty3.default)(_ref2, 'NOC_COMMON_TABLE_COL_NOC_NO_LABEL', item.fireNOCNumber || "-"), (0, _defineProperty3.default)(_ref2, 'NOC_TYPE_LABEL', item.fireNOCDetails.fireNOCType || "-"), (0, _defineProperty3.default)(_ref2, 'NOC_COMMON_TABLE_COL_OWN_NAME_LABEL', (0, _get2.default)(item, "fireNOCDetails.applicantDetails.owners[0].name") || "-"), (0, _defineProperty3.default)(_ref2, 'NOC_COMMON_TABLE_COL_APP_DATE_LABEL', (0, _index.convertEpochToDate)(parseInt(item.fireNOCDetails.applicationDate)) || "-"), (0, _defineProperty3.default)(_ref2, "TENANT_ID", item.tenantId), (0, _defineProperty3.default)(_ref2, 'NOC_COMMON_TABLE_COL_STATUS_LABEL', item.fireNOCDetails.status || "-"), _ref2;
            });


            dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResults", "props.data", data));
            dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResults", "props.rows", response.FireNOCs.length));
