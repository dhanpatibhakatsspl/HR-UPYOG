  ...
  function DocumentList() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocumentList.__proto__ || Object.getPrototypeOf(DocumentList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
          ...
          _this$props$documents2 = _this$props.documentsEditFlow,
          documentsEditFlow = _this$props$documents2 === undefined ? {} : _this$props$documents2;
          ...
          if (card.subCards) {
            card.subCards.forEach(function (subCard) {
              ...
              if (oldDocType != docType.code || oldDocCode != card.name || oldDocSubCode != subCard.name) {
                ...
                if (documentsEditFlow && documentsEditFlow[subCard.name]) {
                  documentsUploadRedux[index]['documents'] = [(0, _extends5.default)({}, documentsEditFlow[subCard.name])];
            ...
            if (oldDocType != docType.code || oldDocCode != card.name) {
              ...
              if (documentsEditFlow && documentsEditFlow[card.name]) {
                documentsUploadRedux[index]['documents'] = [(0, _extends5.default)({}, documentsEditFlow[card.name])];
                documentsUploadRedux[index]['dropdown'] = {};
      ...
      _this.setState({ loadedDocs: true });
              ...
              case 4:
                ...
                prepareFinalObject("documentsUploadRedux", (0, _extends5.default)({}, documentsUploadRedux, (0, _defineProperty3.default)({}, uploadedDocIndex, (0, _extends5.default)({}, documentsUploadRedux[uploadedDocIndex], {
                  documents: [{
                    ...
                    fileUrl: (0, _commons.getFileUrl)(Object.values(fileUrl)[0])
                  }]
                }))));
                _this.hideLoading();
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          false && _react2.default.createElement(_uiContainersLocal.AutosuggestContainer, {
            select: true,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_uiMoleculesLocal.UploadSingleFile, {
            ...
            buttonLabel: (0, _extends5.default)({}, _this.props.buttonLabel, { style: { padding: "10px 30px" } })
          })
        )
      );
  ...
  (0, _createClass3.default)(DocumentList, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          fileUploadStatus = _props.fileUploadStatus;
...
var mapStateToProps = function mapStateToProps(state) {
  ...
  var documentsEditFlow = (0, _get2.default)(screenConfiguration.preparedFinalObject, "documentsEditFlow", {});
  return { documentsUploadRedux: documentsUploadRedux, documentsEditFlow: documentsEditFlow, moduleName: moduleName };
};
