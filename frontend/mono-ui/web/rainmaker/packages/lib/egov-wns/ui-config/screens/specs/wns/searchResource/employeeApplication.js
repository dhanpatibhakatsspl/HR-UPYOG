...
exports.wnsApplication = undefined;
...
var wnsApplication = exports.wnsApplication = (0, _utils.getCommonCard)({
  ...
  wnsApplicationContainer: (0, _utils.getCommonContainer)({
    city: {
  ...
  button: (0, _utils.getCommonContainer)({
    buttonContainer: (0, _utils.getCommonContainer)({
      resetButton: {
        ...
        onClickDefination: {
          action: "condition",
          callBack: _utils2.resetFieldsForConnection
        }
      },
      searchButton: {
        componentPath: "Button",
