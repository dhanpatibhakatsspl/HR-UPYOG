...
var _adhocPopupViewBill = require("./applyResource/adhocPopupViewBill");
...
var consumerCode = (0, _commons2.getQueryArg)(window.location.href, "connectionNumber");
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          if (service === _commons.serviceConst.WATER) {
                          ...
                          _context.next = 5;
                          return (0, _commons.getDescriptionFromMDMS)(body, dispatch);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 1;
            _context3.next = 4;
            return (0, _commons.getDescriptionFromMDMS)(requestBody, dispatch);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (!(serviceUrl === _commons.serviceConst.WATER)) {
              _context4.next = 32;
              break;
            }

            _context4.next = 7;
            return (0, _commons.getConsumptionDetails)(queryObjectForConsumptionDetails, dispatch);

          case 7:
            meterReadingsData = _context4.sent;
            _context4.next = 10;
            return (0, _commons.getSearchResults)(queryObjForSearch, true);

          case 10:
            payload = _context4.sent;
            queryObjectForFetchBill = [{ key: "tenantId", value: tenantId }, { key: "consumerCode", value: consumerCode }, { key: "businessService", value: "WS" }];
            _context4.next = 14;
            return (0, _commons.fetchBill)(queryObjectForFetchBill, dispatch);
          ...
          case 32:
            if (!(serviceUrl === _commons.serviceConst.SEWERAGE)) {
              _context4.next = 54;
              break;
            }
            ...
            _context4.next = 36;
            return (0, _commons.getSearchResultsForSewerage)(queryObjForSearch, dispatch, true);

          case 36:
            _payload = _context4.sent;
            _context4.next = 39;
            return (0, _commons.fetchBill)(_queryObjectForFetchBill, dispatch);
...
var billHeader = function billHeader() {
  ...
  } else if (service === _commons.serviceConst.SEWERAGE) {
...
var estimate = (0, _utils.getCommonGrayCard)({
  header: (0, _utils.getCommonSubHeader)({ labelKey: "WS_VIEWBILL_DETAILS_HEADER" }),
...
var viewBill = exports.viewBill = (0, _utils.getCommonCard)({ estimate: estimate, serviceDetails: serviceDetails, propertyDetails: propertyDetails, ownerDetails: ownerDetails });

var screenConfig = {
  uiFramework: "material-ui",
  name: "viewBill",
  beforeInitScreen: function beforeInitScreen(action, state, dispatch) {
    consumerCode = (0, _commons2.getQueryArg)(window.location.href, "connectionNumber");
    ...
    (0, _set2.default)(action, "screenConfig.components.adhocDialog.children.popup", _adhocPopupViewBill.adhocPopupViewBill);
