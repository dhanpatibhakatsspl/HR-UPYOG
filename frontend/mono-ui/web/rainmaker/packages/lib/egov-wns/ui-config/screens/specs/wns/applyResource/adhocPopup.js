...
var getEstimateDataAfterAdhoc = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(state, dispatch) {
    var WSRequestBody, querObj, serviceUrl, WSpayload, billPayload;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            dispatch((0, _actions.prepareFinalObject)("WaterConnection[0]", WSRequestBody[0]));
            dispatch((0, _actions.prepareFinalObject)("WaterConnectionTemp[0]", (0, _cloneDeep2.default)(WSRequestBody[0])));
            (0, _set2.default)(WSRequestBody[0], "action", "ADHOC");
          ...
          case 12:
            ...
            _context.next = 16;
            return (0, _utils2.createEstimateData)(WSpayload.Calculation[0], "dataCalculation", dispatch, window.location.href, (0, _utils2.showHideAdhocPopup)(state, dispatch, "search-preview", false));
...
var updateAdhoc = function updateAdhoc(state, dispatch) {
  ...
  if (adhocAmount || rebateAmount) {
    var totalAmount = (0, _get2.default)(state.screenConfiguration.preparedFinalObject, "dataCalculation.totalAmount");
          ...
          closeButton: {
            ...
            onClickDefination: {
              ...
              callBack: function callBack(state, dispatch) {
                (0, _utils2.showHideAdhocPopupAndValues)(state, dispatch, "search-preview");
              }
            }
          }
        }
