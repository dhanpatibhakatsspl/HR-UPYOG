...
var searchResults = exports.searchResults = {
  ...
  props: {
        ...
        customBodyRender: function customBodyRender(value) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(_LabelContainer2.default, {
              labelKey: (0, _commons.getTransformedLocale)("WS_" + value),
              style: {
                fontSize: 14
              }
            })
      ...
      name: "Due", labelKey: "WS_COMMON_TABLE_COL_DUE_LABEL", options: {
        ...
        customBodyRender: function customBodyRender(value) {
          return _react2.default.createElement(
            ...
            { style: { color: '#000000' } },
            _react2.default.createElement(_LabelContainer2.default, {
              labelKey: (0, _commons.getTransformedLocale)(value),
              style: {
                fontSize: 14
              }
            })
    ...
    }, { name: "Address", labelKey: "WS_COMMON_TABLE_COL_ADDRESS" }, { name: "Due Date", labelKey: "WS_COMMON_TABLE_COL_DUE_DATE_LABEL" }, {
      name: "Action",
      ...
      options: {
        ...
        customBodyRender: function customBodyRender(value, data) {
          if (data.rowData[4] !== undefined && typeof parseFloat(data.rowData[4]) === 'number' && parseFloat(data.rowData[4]) > 0) {
            ...
            return (0, _commons.getLocaleLabels)("NA", "NA");
          }
        }
      }
    }, {
...
var getViewBillDetails = function getViewBillDetails(data) {
  _store2.default.dispatch((0, _actions.setRoute)("viewBill?connectionNumber=" + data.rowData[1] + "&tenantId=" + data.rowData[8] + "&service=" + data.rowData[0] + "&connectionType=" + data.rowData[9]));
};