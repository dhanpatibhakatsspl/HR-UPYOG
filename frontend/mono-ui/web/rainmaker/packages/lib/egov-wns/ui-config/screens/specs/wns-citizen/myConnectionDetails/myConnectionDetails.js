...
var fetchData = exports.fetchData = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(action, state, dispatch) {
        var finalResponse, queryObject, response, swResponse, myConnectionResults;
                    ...
                    case 7:
                        ...
                        try {
                            ...
                            if (finalResponse && finalResponse.length > 0) {
                                myConnectionResults = finalResponse.filter(function (item) {
                                    return item.connectionNo !== "NA" && item.connectionNo !== null;
                                });

                                dispatch((0, _actions.prepareFinalObject)("myConnectionResults", myConnectionResults));
                                dispatch((0, _actions.prepareFinalObject)("myConnectionsCount", myConnectionResults.length));

                                dispatch((0, _actions.handleScreenConfigurationFieldChange)("my-connections", "components.div.children.header.children.key", "props.dynamicArray", myConnectionResults.length ? [myConnectionResults.length] : [0]));
                            }
                        } catch (error) {};
