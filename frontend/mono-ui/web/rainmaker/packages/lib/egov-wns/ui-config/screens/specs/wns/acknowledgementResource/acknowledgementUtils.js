  ...
  if (number && newNumber) {
    tail = tailText && number && tailTextOne && newNumber && newNumber !== null && number !== "null" ? {
      ...
      children: {
        ...
        paragraph: (0, _utils.getCommonHeader)({ labelName: number }, { style: style.tailNumber }),
        textOne: (0, _utils.getCommonHeader)(tailTextOne, { style: style.tailText }),
        paragraphOne: (0, _utils.getCommonHeader)({ labelName: newNumber }, { style: style.tailNumber })
      },
      props: {
        style: style.tailBox
      }
