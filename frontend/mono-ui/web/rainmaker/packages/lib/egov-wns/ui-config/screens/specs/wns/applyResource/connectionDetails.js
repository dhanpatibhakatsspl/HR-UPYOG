...
exports.OwnerInfoCard = exports.getCheckboxContainer = undefined;
...
var getCheckboxContainer = exports.getCheckboxContainer = {
...
var OwnerInfoCard = exports.OwnerInfoCard = (0, _utils.getCommonCard)({
  ...
  header: (0, _utils.getCommonSubHeader)({ labelName: "Connection Details", labelKey: "WS_COMMON_CONNECTION_DETAILS" }, { style: { marginBottom: 18 } }),

  tradeUnitCardContainer: (0, _utils.getCommonContainer)({
    getCheckboxContainer: getCheckboxContainer,
    ...
    numberOfWaterClosets: (0, _utils.getTextField)({
    ...
    numberOfToilets: (0, _utils.getTextField)({
