...
var _CustomTab = require("egov-ui-framework/ui-molecules/CustomTab");
...
var MultiItem = function (_React$Component) {
  ...
  function MultiItem() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MultiItem.__proto__ || Object.getPrototypeOf(MultiItem)).call.apply(_ref, [this].concat(args))), _this), _this.state = { tabIndex: 0 }, _this.componentWillMount = function () {
      var tabIndex = _this.props.tabIndex;

      if (tabIndex != "" && typeof tabIndex === 'number') {
        _this.onTabClick(tabIndex);
      }
      ...
      if (value === "SEARCH_CONNECTION") {
        (0, _utils.resetFieldsForApplication)({}, dispatch);
        dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchApplicationResults", "visible", false));
      } else {
        (0, _utils.resetFieldsForConnection)({}, dispatch);
        dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResults", "visible", false));
      }
    }, _this.onTabChange = function (tabIndex, dispatch, state) {
      switch (tabIndex) {
        case 0:
          _this.setInstrumentType("SEARCH_CONNECTION", dispatch);
          break;
        case 1:
          _this.setInstrumentType("SEARCH_APPLICATION", dispatch);
          break;
        default:
          _this.setInstrumentType("SEARCH_CONNECTION", dispatch);
          break;
