...
var EstimateCardContainer = function (_Component) {
  ...
  function EstimateCardContainer(props) {
    (0, _classCallCheck3.default)(this, EstimateCardContainer);
    return (0, _possibleConstructorReturn3.default)(this, (EstimateCardContainer.__proto__ || Object.getPrototypeOf(EstimateCardContainer)).call(this, props));
  }

  (0, _createClass3.default)(EstimateCardContainer, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(_uiMoleculesLocal.FeesEstimateCard, { estimate: this.props.estimate, isCardrequired: this.props.isCardrequired ? this.props.isCardrequired : false });
    }
  }]);
