  ...
  function AutoSuggestor() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = AutoSuggestor.__proto__ || Object.getPrototypeOf(AutoSuggestor)).call.apply(_ref, [this].concat(args))), _this), _this.onSelect = function (value) {
      ...
      var _this$props2 = _this.props,
          ...
          _this$props2$suggesti = _this$props2.suggestions,
          suggestions = _this$props2$suggesti === undefined ? [] : _this$props2$suggesti,
          _this$props2$disabled = _this$props2.disabled,
          disabled = _this$props2$disabled === undefined ? false : _this$props2$disabled,
...
var getLocalisedSuggestions = function getLocalisedSuggestions(suggestions, localePrefix, transfomedKeys) {
  return suggestions && Array.isArray(suggestions) && suggestions.length > 0 && suggestions.map(function (option, key) {
    option.name = Number(option.code) && Number(option.code) != "NAN" ? option.code : (0, _commons.getLocaleLabels)(option.code, localePrefix && !(0, _isEmpty2.default)(localePrefix) ? (0, _commons.appendModulePrefix)(option.code, localePrefix) : option.name, transfomedKeys);
    return option;
