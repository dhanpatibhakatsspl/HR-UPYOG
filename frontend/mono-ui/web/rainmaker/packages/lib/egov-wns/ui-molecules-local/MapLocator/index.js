...
var _appConfig = require("egov-ui-framework/ui-config/app-config");
...
var MapLocator = function (_Component) {
  ...
  function MapLocator(props) {
    ...
    _this.closeMapPopup = function () {
      _this.props.handleField("apply", "components.div.children.formwizardFirstStep.children.tradeLocationDetails.children.cardContent.children.mapsDialog", "props.open", false);
    };

    _this.onClickPick = function () {
      _this.props.handleField("apply", "components.div.children.formwizardFirstStep.children.tradeLocationDetails.children.cardContent.children.tradeDetailsConatiner.children.tradeLocGISCoord.children.gisTextField", "props.value", add.lat + ", " + add.lng);
      _this.props.prepareFinalObject("Licenses[0].tradeLicenseDetail.address.latitude", add.lat);
      _this.props.prepareFinalObject("Licenses[0].tradeLicenseDetail.address.longitude", add.lng);
  ...
  (0, _createClass3.default)(MapLocator, [{
    ...
    value: function render() {
      ...
      var _currloc = !(0, _isEmpty2.default)(currLoc) ? currLoc : (0, _isEmpty2.default)(location) ? _appConfig.defaultLocation : location;
      var translatedSearchPlaceholder = (0, _commons.getLocaleLabels)("Search Address", "TL_SEARCH_ADDRESS_MAP_PLACEHOLDER", localizationLabels);
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_uiAtoms.MapLocation, {
          currLoc: _currloc,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_uiAtoms.Button, {
            ...
            children: _react2.default.createElement(_uiContainers.LabelContainer, {
              labelName: "Close",
...
exports.default = (0, _reactRedux.connect)(mapSateToProps, mapDispatchToProps)(MapLocator);