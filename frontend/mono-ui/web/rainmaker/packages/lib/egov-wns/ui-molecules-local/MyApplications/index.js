...
var MyApplications = function (_React$Component) {
  (0, _inherits3.default)(MyApplications, _React$Component);
  ...
  function MyApplications() {
    ...
    (0, _classCallCheck3.default)(this, MyApplications);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MyApplications.__proto__ || Object.getPrototypeOf(MyApplications)).call.apply(_ref, [this].concat(args))), _this), _this.clickHandler = function (route) {
      _store2.default.dispatch((0, _actions.setRoute)(route));
    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }

  (0, _createClass3.default)(MyApplications, [{
    key: "render",
    value: function render() {
      ...
      var myApplicationCount = Count ? [Count] : [0];
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { component: "nav", onClick: function onClick() {
              return _this2.clickHandler(route);
            } },
          _react2.default.createElement(
            _ListItem2.default,
            { button: true },
...
exports.default = (0, _styles.withStyles)(styles)(MyApplications);