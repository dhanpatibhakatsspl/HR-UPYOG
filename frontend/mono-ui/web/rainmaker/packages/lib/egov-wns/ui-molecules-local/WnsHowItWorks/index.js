...
var _index = require("../../ui-atoms-local/BreadCrumbs/index");
...
var WnsHowItWorks = function (_Component) {
  (0, _inherits3.default)(WnsHowItWorks, _Component);

  function WnsHowItWorks() {
    var _ref;

    var _temp, _this, _ret;

    (0, _classCallCheck3.default)(this, WnsHowItWorks);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = WnsHowItWorks.__proto__ || Object.getPrototypeOf(WnsHowItWorks)).call.apply(_ref, [this].concat(args))), _this), _this.listItems = [{
  ...
  (0, _createClass3.default)(WnsHowItWorks, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_index2.default, { url: urls, history: history, label: "COMMON_HOW_IT_WORKS" }),
        _react2.default.createElement(
          "div",
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(WnsHowItWorks);