...
var DocumentList = function (_Component) {
  ...
  function DocumentList() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocumentList.__proto__ || Object.getPrototypeOf(DocumentList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var index = 0;
      if (_lodash2.default.isEmpty(documentsUploadRedux)) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                prepareFinalObject("documentsUploadRedux", (0, _extends5.default)({}, documentsUploadRedux, (0, _defineProperty3.default)({}, uploadedDocIndex, (0, _extends5.default)({}, documentsUploadRedux[uploadedDocIndex], { documents: [{ fileName: file.name, fileStoreId: fileStoreId, fileUrl: Object.values(fileUrl)[0] }]
                }))));
                _this.hideLoading();
      ...
      var jsonPath = "";
      if (!_lodash2.default.isEmpty(documentsUploadRedux) && documentsUploadRedux[key] && documentsUploadRedux[key].dropdown && documentsUploadRedux[key].dropdown.value) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          card.dropdown && _react2.default.createElement(_uiContainersLocal.AutosuggestContainer, {
            select: true,
            label: { labelKey: (0, _commons.getTransformedLocale)(card.dropdown.label), labelName: (0, _commons.getTransformedLocale)(card.dropdown.label) },
