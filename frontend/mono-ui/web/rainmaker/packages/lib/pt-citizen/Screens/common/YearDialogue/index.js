...
var YearDialogueHOC = (0, _form2.default)({
  formKey: "financialYear",
  path: "PropertyTaxPay",
  isCoreConfiguration: true
})(_RadioButtonForm2.default);
      ...
      return getYearList ? _react2.default.createElement(_components.Dialog, {
        ...
        children: [_react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            Object.values(getYearList).map(function (item, index) {
            ...
            _react2.default.createElement(_components.Button, {
              ...
              buttonStyle: { border: "1px solid rgb(255, 255, 255)" }, onClick: function onClick() {
                if (_this2.state.selectedYear !== '') {
                  _this2.resetForm();
                  history && urlToAppend ? history.push(urlToAppend + "&FY=" + _this2.state.selectedYear) : history.push("/property-tax/assessment-form?FY=" + _this2.state.selectedYear + "&type=new");
                } else {
