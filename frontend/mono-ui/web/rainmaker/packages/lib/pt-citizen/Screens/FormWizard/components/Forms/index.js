...
exports.InstitutionAuthorityHOC = exports.InstitutionHOC = exports.OwnerInformation = exports.DynamicFormHoc = exports.ExemptionCategoryHOC = exports.OwnerInfoHOC = exports.OwnershipTypeHOC = exports.PropertyAddressHOC = exports.UsageInformationHOC = undefined;
...
var options = [{ value: "Male", label: _react2.default.createElement(_translationNode2.default, { label: "PT_FORM3_MALE" }) }, { value: "Female", label: _react2.default.createElement(_translationNode2.default, { label: "PT_FORM3_FEMALE" }) }, { value: "TRANSGENDER", label: _react2.default.createElement(_translationNode2.default, { label: "PT_FORM3_TRANSGENDER" }) }];
...
var OwnerInformation = function OwnerInformation(_ref) {
  ...
  var genderSelected = (0, _get2.default)(fields, "ownerGender.value", "Male");
  return _react2.default.createElement(_components.Card, {
    textChildren: _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        !disabled && deleteBtn && _react2.default.createElement(
          "div",
          {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "col-sm-6" },
          _react2.default.createElement(_translationNode2.default, { label: "PT_FORM3_GENDER", required: true, fontSize: 12, labelStyle: styles.labelStyle, bold: true }),
          _react2.default.createElement(_components.RadioButton, (0, _defineProperty3.default)({
            id: "gender-selection",
        ...
        _react2.default.createElement(
          "div",
          { className: "col-sm-6" },
          _react2.default.createElement(_field2.default, { fieldKey: "ownerAlterMobile", field: fields["ownerAlterMobile"], handleFieldChange: handleFieldChange, disabled: disabled })
        ),
        _react2.default.createElement(
          "div",
          { style: { padding: 0 }, className: "col-sm-6" },
          _react2.default.createElement(
            "div",
            { className: "col-sm-6" },
        ...
        _react2.default.createElement(
          "div",
          { className: "col-sm-6 ownerCategoryIdType", style: { display: "flex", alignItems: "center" } },
          _react2.default.createElement(_field2.default, {
          ...
          fields["ownerCategoryIdType"] && fields["ownerCategoryIdType"].toolTip && !fields["ownerCategoryIdType"].hideField && _react2.default.createElement(_components.ToolTipUi, { id: "form-wizard-tooltip", title: fields["ownerCategoryIdType"].toolTipMessage })
        ),
        _react2.default.createElement(
          "div",
          { className: "col-sm-6", style: { display: "flex", alignItems: "center" } },
          ...
          fields["ownerCategoryId"] && fields["ownerCategoryId"].toolTip && !fields["ownerCategoryId"].hideField && _react2.default.createElement(_components.ToolTipUi, { id: "form-wizard-tooltip", title: fields["ownerCategoryId"].toolTipMessage })
        ),
        _react2.default.createElement(
          "div",
          { className: "col-sm-6", style: { paddingBottom: "4px", paddingTop: "2px" } },
        ...
        _react2.default.createElement(
          "div",
          { className: "col-sm-6", style: { paddingBottom: "8px" } },
    ...
    textChildren: _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_field2.default, { fieldKey: "alterMobile", field: fields["alterMobile"], handleFieldChange: handleFieldChange, disabled: disabled }),
...
var UsageInformationHOC = (0, _form2.default)({ formKey: "basicInformation", path: "PropertyTaxPay", isCoreConfiguration: true })(_GenericForm2.default);
var PropertyAddressHOC = (0, _form2.default)({ formKey: "propertyAddress", path: "PropertyTaxPay", isCoreConfiguration: true })(_GenericForm2.default);
//const PlotInformationHOC = formHoc({ formKey: "plotInformation", path: "PropertyTaxPay" })(GenericForm);
var OwnershipTypeHOC = (0, _form2.default)({ formKey: "ownershipType", path: "PropertyTaxPay", isCoreConfiguration: true })(_GenericForm2.default);
var OwnerInfoHOC = (0, _form2.default)({ formKey: "ownerInfo", path: "PropertyTaxPay", isCoreConfiguration: true })(OwnerInformation);
var ExemptionCategoryHOC = (0, _form2.default)({ formKey: "exemptionCategory", path: "PropertyTaxPay", isCoreConfiguration: true })(_GenericForm2.default);
var InstitutionHOC = (0, _form2.default)({ formKey: "institutionDetails", path: "PropertyTaxPay/OwnerInformation/Institution", isCoreConfiguration: true })(_GenericForm2.default);
var DynamicFormHoc = function DynamicFormHoc(formKey, Form) {
  return (0, _form2.default)({ formKey: formKey })(Form);
};
var InstitutionAuthorityHOC = (0, _form2.default)({
