...
var PaymentSuccess = function (_Component) {
  ...
  function PaymentSuccess() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PaymentSuccess.__proto__ || Object.getPrototypeOf(PaymentSuccess)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      imageUrl: "",
      yearDialogue: {
        dialogueOpen: false,
        urlToAppend: ''
      }
    }, _this.toggleYearDialogue = function (assessmentNumber) {
      var assessmentId = assessmentNumber;
      _this.setState({
        yearDialogue: {
          dialogueOpen: !_this.state.yearDialogue.dialogueOpen,
          urlToAppend: "/property-tax/assessment-form?assessmentId=" + assessmentId + "&purpose=assess&propertyId=" + _this.props.match.params.propertyId + "&tenantId=" + _this.props.match.params.tenantId
        }
      });
    }, _this.icon = _react2.default.createElement(_components.Icon, { action: "navigation", name: "check" }), _this.buttons = {
