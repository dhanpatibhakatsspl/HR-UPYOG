    ...
    tabs.map(function (tab, index) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "breadcrumb-tab", style: { cursor: "pointer" } },
          _react2.default.createElement(
            "div",
            { className: "tab-icon" },
          ...
          _react2.default.createElement(_translationNode2.default, { label: tab.heading, labelStyle: { letterSpacing: 0.6 }, color: "#fff", bold: true })
        )
      );
    })
  );
