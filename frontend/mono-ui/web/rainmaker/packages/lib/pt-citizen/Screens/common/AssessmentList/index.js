    ...
    case "Paid":
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "assessment-displayInline", style: item.date ? { marginTop: 8 } : { marginTop: "0px" } },
          _react2.default.createElement(_translationNode2.default, { label: item.status, labelStyle: { marginLeft: 10 }, color: "#22b25f" }),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_components.Button, {
          ...
          onClick: function onClick(e) {
            ...
            history.push((0, _formUtils.getPropertyLink)(item.propertyId, item.tenantId, "assess", item.financialYear, item.assessmentNo));
          },
          style: {
            height: 20,
            lineHeight: "auto",
