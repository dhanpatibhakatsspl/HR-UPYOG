...
require("../../FormWizard/components/WizardComponent/index.css");
...
var PaymentStatus = function PaymentStatus(_ref) {
  ...
  return _react2.default.createElement(
          ...
          receiptUIDetails && receiptUIDetails.propertyInfo && receiptUIDetails.propertyInfo.map(function (item) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(_translationNode2.default, {
                className: "col-xs-6",
                label: item.key,
                dynamicArray: item.dynamicArray ? item.dynamicArray : []
              }),
              _react2.default.createElement(
                "span",
                null,
          ...
          receiptUIDetails && receiptUIDetails.receiptInfo && receiptUIDetails.receiptInfo.map(function (item) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(_translationNode2.default, {
                className: "col-xs-6",
                labelStyle: labelStyle,
                label: item.value || item.value === "0" ? item.value : "NA"
              })
            );
          })
        )
      ...
      receiptDetails && receiptDetails.ReceiptNo && _react2.default.createElement(
        "div",
        {
          onClick: function onClick() {
            (0, _receiptsPDF2.default)("pt-reciept-citizen", receiptDetails, generalMDMSDataById);
          }
        },
        _react2.default.createElement(_translationNode2.default, {
    ...
    _react2.default.createElement(_common.ActionFooter, { label2: buttons.button2, primaryAction: primaryAction })
  );
};
