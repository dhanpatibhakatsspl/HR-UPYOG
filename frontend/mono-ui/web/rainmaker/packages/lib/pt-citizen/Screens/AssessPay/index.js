...
var AssessPay = function (_Component) {
  ...
  function AssessPay(props) {
    ...
    _this.state = {
      dialogueOpen: false,
      items: [{
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "PT_ADD_NEW_PROPERTY", fontSize: "16px", color: "#484848", labelStyle: { fontWeight: 500 } }),
        route: "/date-dialogue",
        ...
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "PT_SEARCH_PROPERTY", fontSize: "16px", color: "#484848", labelStyle: { fontWeight: 500 } }),
