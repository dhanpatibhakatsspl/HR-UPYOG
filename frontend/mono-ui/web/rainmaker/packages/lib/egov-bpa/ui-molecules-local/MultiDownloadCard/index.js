...
function MultiCardDownloadGrid(props) {
  var classes = props.classes,
      data = props.data,
      name = props.name,
      rest = (0, _objectWithoutProperties3.default)(props, ["classes", "data", "name"]);

  return _react2.default.createElement(
    _Grid2.default,
    (0, _extends3.default)({ container: true }, rest),
    data && data.length && data.map(function (item, key) {
      return _react2.default.createElement(
        _Grid2.default,
        {
          item: true,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            item && item.wfState ? _react2.default.createElement(
              _Typography2.default,
              { className: classes.body2 },
              "WfState : ",
              item.wfState
            ) : null,
            item && item.createdBy ? _react2.default.createElement(
              _Typography2.default,
              { className: classes.body2 },
              "CreatedBy: ",
              item.createdBy
