  ...
  function DocumentList() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = DocumentList.__proto__ || Object.getPrototypeOf(DocumentList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
          ...
          _this$props$bparegDoc = _this$props.bparegDocumentDetailsUploadRedux,
          bparegDocumentDetailsUploadRedux = _this$props$bparegDoc === undefined ? {} : _this$props$bparegDoc,
        ...
        docType.cards && docType.cards.forEach(function (card) {
          if (card.subCards) {
            card.subCards.forEach(function (subCard) {
              var oldDocType = (0, _get2.default)(bparegDocumentDetailsUploadRedux, "[" + index + "].documentType");
              var oldDocCode = (0, _get2.default)(bparegDocumentDetailsUploadRedux, "[" + index + "].documentCode");
              var oldDocSubCode = (0, _get2.default)(bparegDocumentDetailsUploadRedux, "[" + index + "].documentSubCode");
      ...
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(file, fileStoreId) {
        var uploadedDocIndex, _this$props2, prepareFinalObject, bparegDocumentDetailsUploadRedux, fileUrl, appDocumentList;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this$props2 = _this.props, prepareFinalObject = _this$props2.prepareFinalObject, bparegDocumentDetailsUploadRedux = _this$props2.bparegDocumentDetailsUploadRedux;
                _context.next = 4;
                return (0, _commons.getFileUrlFromAPI)(fileStoreId);

              case 4:
                fileUrl = _context.sent;
                appDocumentList = (0, _extends5.default)({}, bparegDocumentDetailsUploadRedux, (0, _defineProperty3.default)({}, uploadedDocIndex, (0, _extends5.default)({}, bparegDocumentDetailsUploadRedux[uploadedDocIndex], {
                  documents: [{
                    fileName: file.name,
      ...
      prepareFinalObject("bparegDocumentDetailsUploadRedux." + remDocIndex + ".documents", undefined);
      _this.forceUpdate();
    }, _this.handleChange = function (key, event) {
      var _this$props3 = _this.props,
          bparegDocumentDetailsUploadRedux = _this$props3.bparegDocumentDetailsUploadRedux,
          prepareFinalObject = _this$props3.prepareFinalObject;

      var appDocumentList = (0, _extends5.default)({}, bparegDocumentDetailsUploadRedux, (0, _defineProperty3.default)({}, key, (0, _extends5.default)({}, bparegDocumentDetailsUploadRedux[key], {
      ...
      var _this$props4 = _this.props,
          ...
          bparegDocumentDetailsUploadRedux = _this$props4.bparegDocumentDetailsUploadRedux;

      var jsonPath = "bparegDocumentDetailsUploadRedux[" + key + "].dropDownValues.value";
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          bparegDocumentDetailsUploadRedux[key] && bparegDocumentDetailsUploadRedux[key].documents ? _react2.default.createElement(
            "div",
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { variant: "caption" },
            _react2.default.createElement(_uiContainers.LabelContainer, {
              labelKey: (0, _commons.getTransformedLocale)("BPA_UPLOAD_FILE_RESTRICTIONS")
            })
          )
        ),
        _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_uiMoleculesLocal.UploadSingleFile, {
            ...
            uploaded: bparegDocumentDetailsUploadRedux[key] && bparegDocumentDetailsUploadRedux[key].documents ? true : false,
            removeDocument: function removeDocument() {
              return _this.removeDocument(key);
            },
            documents: bparegDocumentDetailsUploadRedux[key] && bparegDocumentDetailsUploadRedux[key].documents,
...
var mapStateToProps = function mapStateToProps(state) {
  ...
  var bparegDocumentDetailsUploadRedux = (0, _get2.default)(screenConfiguration.preparedFinalObject, "bparegDocumentDetailsUploadRedux", {});
  return { bparegDocumentDetailsUploadRedux: bparegDocumentDetailsUploadRedux, moduleName: moduleName };
};
