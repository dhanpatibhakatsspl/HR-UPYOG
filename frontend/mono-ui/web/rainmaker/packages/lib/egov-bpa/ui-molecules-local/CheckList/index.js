...
var CheckList = function (_Component) {
  (0, _inherits3.default)(CheckList, _Component);
  ...
  function CheckList() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CheckList.__proto__ || Object.getPrototypeOf(CheckList)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      uploadedDocIndex: 0,
      checkListUploaRedux: []
      ...
      var checkListUploaRedux = _this.state.checkListUploaRedux;
        ...
        docType.cards && docType.cards.forEach(function (card) {
          if (card.subCards) {
            card.subCards.forEach(function (subCard) {
              var oldDocType = (0, _get2.default)(checkListUploaRedux, "[" + index + "].documentType");
              var oldDocCode = (0, _get2.default)(checkListUploaRedux, "[" + index + "].documentCode");
              var oldDocSubCode = (0, _get2.default)(checkListUploaRedux, "[" + index + "].documentSubCode");
      ...
      _this.setState((0, _extends6.default)({}, _this.state, { "checkListUploaRedux": checkListUploaRedux }));
    }, _this.prepareDocumentsInEmployee = function () {
      var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(checkListDocuments, bpaDetails) {
        var documnts, finalQstn;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (documnts && documnts.length > 0) {
                  ...
                  _this.props.dispatch((0, _actions.prepareFinalObject)(_this.props.jsonPath, finalQstn));
                }
      ...
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(file, fileStoreId) {
        var _this$state, uploadedDocIndex, checkListUploaRedux, _this$props2, prepareFinalObject, bpaDetails, fileUrl, checkListDocuments, isEmployee;

        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this$state = _this.state, uploadedDocIndex = _this$state.uploadedDocIndex, checkListUploaRedux = _this$state.checkListUploaRedux;
                _this$props2 = _this.props, prepareFinalObject = _this$props2.prepareFinalObject, bpaDetails = _this$props2.bpaDetails;
                _context2.next = 4;
                return (0, _commons.getFileUrlFromAPI)(fileStoreId);

              case 4:
                fileUrl = _context2.sent;
                checkListDocuments = (0, _extends6.default)({}, checkListUploaRedux, (0, _defineProperty3.default)({}, uploadedDocIndex, (0, _extends6.default)({}, checkListUploaRedux[uploadedDocIndex], {
                  documents: [{
                    fileName: file.name,
                ...
                _this.setState((0, _extends6.default)({}, _this.state, { "checkListUploaRedux": checkListDocuments }));

                isEmployee = process.env.REACT_APP_NAME === "Citizen" ? false : true;


                if (isEmployee) {
                  _this.prepareDocumentsInEmployee(checkListDocuments, bpaDetails);
                }
      ...
      prepareFinalObject("checkListUploaRedux." + remDocIndex + ".documents", undefined);
      _this.forceUpdate();
      ...
      var checkListDocuments = (0, _extends6.default)({}, checkListUploaRedux, (0, _defineProperty3.default)({}, key, (0, _extends6.default)({}, checkListUploaRedux[key], {
    ...
    }, _this.handleFieldChange = function (key, event) {
      ...
      var jsonPath = checkListUploaRedux[key] && checkListUploaRedux[key].dropDownValues ? checkListUploaRedux[key].dropDownValues.value : "";
      var jsonPathForRemarks = checkListUploaRedux[key] && checkListUploaRedux[key].remarks ? checkListUploaRedux[key].remarks : "";
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          checkListUploaRedux[key] && checkListUploaRedux[key].documents ? _react2.default.createElement(
            "div",
        ...
        _react2.default.createElement(
          ...
          card.dropDownValues && _react2.default.createElement(_uiContainers.TextFieldContainer, {
            select: true,
            label: { labelKey: (0, _commons.getTransformedLocale)(card.dropDownValues.label) },
            placeholder: { labelKey: (0, _commons.getTransformedLocale)(card.dropDownValues.label) },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_uiContainers.TextFieldContainer, {
            select: false,
            label: { labelKey: (0, _commons.getTransformedLocale)("BPA_ENTER_REMARKS") },
            placeholder: { labelKey: (0, _commons.getTransformedLocale)("BPA_ENTER_REMARKS") },
            value: jsonPathForRemarks,
            onChange: function onChange(event) {
              return _this.handleFieldChange(key, event);
            }
          })
        )
      );
...
var mapStateToProps = function mapStateToProps(state) {
  ...
  return { moduleName: moduleName, bpaDetails: bpaDetails };
};
...
exports.default = (0, _styles.withStyles)(themeStyles)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CheckList));