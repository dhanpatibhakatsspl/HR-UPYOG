...
var MapLocator = function (_Component) {
  ...
  function MapLocator(props) {
    ...
    _this.closeMapPopup = function () {
      _this.props.handleField("apply", "components.div.children.formwizardFirstStep.children.bpaLocationDetails.children.cardContent.children.mapsDialog", "props.open", false);
    };

    _this.onClickPick = function () {
      _this.props.handleField("apply", "components.div.children.formwizardFirstStep.children.bpaLocationDetails.children.cardContent.children.bpaDetailsConatiner.children.tradeLocGISCoord.children.gisTextField", "props.value", add.lat + ", " + add.lng);
      _this.props.prepareFinalObject("BPA.landInfo.address.geoLocation.latitude", add.lat);
      _this.props.prepareFinalObject("BPA.landInfo.address.geoLocation.longitude", add.lng);
