  ...
  (0, _createClass3.default)(PreviewContainer, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = (0, _objectWithoutProperties3.default)(_props, ["finalCardsforPreview", "documentData", "bpaDetails"]);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleDocument = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(file, fileStoreId) {
      var uploadedDocIndex, _props3, prepareFinalObject, documentDetailsUploadRedux, finalCardsforPreview, bpaDetails, wfState, fileUrl, documentCode, documentMenu, appDocumentList, fileObj;
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              uploadedDocIndex = _this3.state.uploadedDocIndex;
              _props3 = _this3.props, prepareFinalObject = _props3.prepareFinalObject, documentDetailsUploadRedux = _props3.documentDetailsUploadRedux, finalCardsforPreview = _props3.finalCardsforPreview, bpaDetails = _props3.bpaDetails, wfState = _props3.wfState;
              _context.next = 4;
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var bpaDetails = (0, _get2.default)(screenConfiguration.preparedFinalObject, modulePath, {});
  var wfState = (0, _get2.default)(screenConfiguration.preparedFinalObject.applicationProcessInstances, "state");

  return { documentDetailsUploadRedux: documentDetailsUploadRedux, finalCardsforPreview: finalCardsforPreview, bpaDetails: bpaDetails, wfState: wfState };
};
