  ...
  (0, _createClass3.default)(AutoSuggestor, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = (0, _objectWithoutProperties3.default)(_props, ["value", "preparedFinalObject", "label", "placeholder", "suggestions", "className", "localizationLabels", "jsonPath"]);
...
var mapStateToProps = function mapStateToProps(state, ownprops) {
  ...
  if (jsonPath.includes("edcr.blockDetail")) {
    if (value && Array.isArray(value)) {
      var valuesArray = [];
      value.forEach(function (echValue) {
        var translatedLabel = (0, _commons2.getLocaleLabels)("BPA_SUBOCCUPANCYTYPE_" + echValue.value, "BPA_SUBOCCUPANCYTYPE_" + echValue.value, localizationLabels);
