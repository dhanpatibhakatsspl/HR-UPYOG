...
exports.loadPdfGenerationData = exports.loadReceiptGenerationData = exports.loadUserNameData = exports.loadMdmsData = exports.loadReceiptData = exports.loadApplicationData = exports.loadUlbLogo = undefined;
...
var loadApplicationData = exports.loadApplicationData = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(applicationNumber, tenant) {
    var data, queryObject, response, cityCode, ownersData, licenseIssueDate, licenseValidTo;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (response && response.Bpa && response.Bpa.length > 0) {
              data.applicationNumber = nullToNa((0, _get2.default)(response, "Bpa[0].applicationNumber", "NA"));
              data.oldLicenseNumber = nullToNa((0, _get2.default)(response, "Bpa[0].oldLicenseNumber", "NA"));
              data.applicationType = getMessageFromLocalization(nullToNa((0, _get2.default)(response, "Bpa[0].applicationType", "NA")));
              // data.licenseNumber = nullToNa(
              //   get(response, "Bpa[0].licenseNumber", "NA")
              // );
              data.financialYear = nullToNa((0, _get2.default)(response, "Bpa[0].financialYear", "NA"));
              //data.tradeName = nullToNa(get(response, "Bpa[0].tradeName", "NA"));
              data.doorNo = nullToNa((0, _get2.default)(response, "Bpa[0].address.doorNo", "NA"));
              data.buildingName = nullToNa((0, _get2.default)(response, "Bpa[0].address.buildingName", "NA"));
              data.streetName = nullToNa((0, _get2.default)(response, "Bpa[0].address.street", "NA"));
              data.locality = (0, _get2.default)(response, "Bpa[0].address.locality.name", "NA");
              cityCode = nullToNa((0, _get2.default)(response, "Bpa[0].address.tenantId", "NA"));

              data.city = getMessageFromLocalization("TENANT_TENANTS_" + (0, _commons.getTransformedLocale)(cityCode));
              /** Make owners data array */
              ownersData = (0, _get2.default)(response, "Bpa[0].owners", []);
              ...
              /** End */
              licenseIssueDate = (0, _get2.default)(response, "Bpa[0].issuedDate", "NA");

              data.licenseIssueDate = nullToNa(epochToDate(licenseIssueDate));
              data.licenseExpiryDate = nullToNa(epochToDate((0, _get2.default)(response, "Bpa[0].validTo", "NA")));
              licenseValidTo = (0, _get2.default)(response, "Bpa[0].validTo", "NA");
