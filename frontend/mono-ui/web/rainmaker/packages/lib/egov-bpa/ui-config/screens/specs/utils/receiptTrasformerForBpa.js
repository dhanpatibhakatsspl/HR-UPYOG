...
exports.loadPdfGenerationDataForBpa = exports.loadUserNameData = exports.loadMdmsData = exports.loadReceiptData = exports.loadApplicationData = exports.loadUlbLogo = exports.getMessageFromLocalization = undefined;
...
var loadApplicationData = exports.loadApplicationData = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(applicationNumber, tenant) {
    var data, queryObject, response, owners;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            data = {};
            queryObject = [{ key: "tenantId", value: tenant }, { key: "applicationNos", value: applicationNumber }];
            _context.next = 4;
            return (0, _commons2.getAppSearchResults)(queryObject);

          case 4:
            response = _context.sent;

            _store2.default.dispatch((0, _actions.prepareFinalObject)("Bpa[0]", response.Bpa[0]));

            if (response && response.Bpa && response.Bpa.length > 0) {
              data.applicationNumber = nullToNa((0, _get2.default)(response, "Bpa[0].applicationNo", "NA"));
              data.applicationStatus = (0, _get2.default)(response, "Bpa[0].status");

              // Property Location
              data.propertyId = nullToNa((0, _get2.default)(response, "Bpa[0].address.propertyId", "NA"));
              data.city = nullToNa(getMessageFromLocalization("TENANT_TENANTS_" + (0, _commons.getTransformedLocale)((0, _get2.default)(response, "Bpa[0].address.city", "NA"))));
              data.door = nullToNa((0, _get2.default)(response, "Bpa[0].address.doorNo", "NA"));
              data.buildingName = nullToNa((0, _get2.default)(response, "Bpa[0].address.buildingName", "NA"));
              data.street = nullToNa((0, _get2.default)(response, "Bpa[0].address.street", "NA"));
              data.mohalla = nullToNa(getMessageFromLocalization("revenue.locality." + (0, _commons.getTransformedLocale)((0, _get2.default)(response, "Bpa[0].address.locality.code", "NA"))));
              data.pincode = nullToNa((0, _get2.default)(response, "Bpa[0].address.pincode", "NA"));
              data.gis = nullToNa((0, _get2.default)(response, "Bpa[0].address.locality.latitude", "NA"));
              data.address = createAddress(data.door, data.buildingName, data.street, data.mohalla, data.city);
              // Applicant Details
              owners = (0, _get2.default)(response, "Bpa[0].owners", []);
              ...
              //   )
              // );
              data.institutionName = nullToNa((0, _get2.default)(response, "Bpa[0].additionalDetail.institutionName", "NA"));
              data.telephoneNumber = nullToNa((0, _get2.default)(response, "Bpa[0].additionalDetail.telephoneNumber", "NA"));
              data.institutionDesignation = nullToNa((0, _get2.default)(response, "Bpa[0].additionalDetail.institutionDesignation", "NA"));
              loadUserNameData((0, _get2.default)(response, "Bpa[0].auditDetails.lastModifiedBy"));
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return (0, _utils.getMdmsDataForBpa)(queryObject);
...
var loadPdfGenerationDataForBpa = exports.loadPdfGenerationDataForBpa = function loadPdfGenerationDataForBpa(applicationNumber, tenant) {
