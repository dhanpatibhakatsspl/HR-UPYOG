...
exports.prepareDocsInEmployee = exports.getRedirectionURL = undefined;
...
var _nocFunctions = require("../utils/noc-functions");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var getRedirectionURL = exports.getRedirectionURL = function getRedirectionURL() {
  var redirectionURL = (0, _index.ifUserRoleExists)("CITIZEN") ? "/bpastakeholder-citizen/home" : "/inbox";
...
var applicationOverview = (0, _utils.getCommonContainer)({
  ...
  appOverViewDetailsContainer: (0, _utils.getCommonContainer)({
    ...
    status: (0, _utils.getLabelWithValue)({
      labelName: "Status",
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (response && (0, _get2.default)(response, "Noc[0].nocNo")) {
              dispatch((0, _actions.handleScreenConfigurationFieldChange)("noc-search-preview", "components.div.children.headerDiv.children.header2.children.titlebar2.children.nocApprovalNumber", "props.number", (0, _get2.default)(response, "Noc[0].nocNo")));
            } else {

              dispatch((0, _actions.handleScreenConfigurationFieldChange)("noc-search-preview", "components.div.children.headerDiv.children.header2.children.titlebar2.children.nocApprovalNumber", "visible", false));
            }
            ...
            (0, _nocFunctions.requiredDocumentsData)(state, dispatch, action);
