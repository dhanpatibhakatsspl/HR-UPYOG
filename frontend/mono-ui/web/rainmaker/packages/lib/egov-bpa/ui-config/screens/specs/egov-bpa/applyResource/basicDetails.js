...
exports.basicDetails = undefined;
...
var basicDetails = exports.basicDetails = (0, _utils.getCommonCard)({
  ...
  basicDetailsContainer: (0, _utils.getCommonContainer)({
    scrutinynumber: (0, _utils.getTextField)({
      label: {
      ...
      iconObj: {
        ...
        onClickDefination: {
          ...
          callBack: function callBack(state, dispatch, fieldInfo) {
            (0, _utils2.getScrutinyDetails)(state, dispatch, fieldInfo);
          }
        }
      },
      gridDefination: {
    ...
    occupancy: (0, _utils.getSelectField)({
      label: {
        labelName: "Occupancy",
