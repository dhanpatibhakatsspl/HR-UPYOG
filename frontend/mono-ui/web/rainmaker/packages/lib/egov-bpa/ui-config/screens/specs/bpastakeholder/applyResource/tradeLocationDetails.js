...
exports.permanentAddr = exports.corrospondanceAddr = exports.tradeLocationDetails = undefined;
...
var tradeLocationDetails = exports.tradeLocationDetails = (0, _utils.getCommonCard)({
  ...
  tradeDetailsConatiner: (0, _utils.getCommonContainer)({
    permanantAddress: (0, _utils.getTextField)({
      label: {
      ...
      jsonPath: "Licenses[0].tradeLicenseDetail.owners[0].address.addressLine1",
      required: true
    }),
    communicationAddress: (0, _utils.getTextField)({
      label: {
...
var corrospondanceAddr = exports.corrospondanceAddr = (0, _utils.getCommonCard)({
  header: (0, _utils.getCommonTitle)({
    labelName: "Communication Address",
  ...
  AddressWithCheckBoxContainer: (0, _utils.getCommonContainer)({
    sameAsPermanentContainer: (0, _utils.getCommonContainer)({
      sameAsPermanent: {
        ...
        props: {
          ...
          sourceJsonPaths: ["LicensesTemp[0].userData.address.buildingName", "LicensesTemp[0].userData.address.city", "LicensesTemp[0].userData.address.doorNo", "LicensesTemp[0].userData.address.landmark", "LicensesTemp[0].userData.address.pincode", "LicensesTemp[0].userData.address.street"],
          destinationJsonPaths: ["Licenses[0].tradeLicenseDetail.address.buildingName", "Licenses[0].tradeLicenseDetail.address.city", "Licenses[0].tradeLicenseDetail.address.doorNo", "Licenses[0].tradeLicenseDetail.address.landmark", "Licenses[0].tradeLicenseDetail.address.pincode", "Licenses[0].tradeLicenseDetail.address.street"],
          disbaleComponentJsonPaths: ["components.div.children.formwizardSecondStep.children.corrospondanceAddr.children.cardContent.children.AddressWithCheckBoxContainer.children.addressContainer.children.tradeLocBuilidingName", "components.div.children.formwizardSecondStep.children.corrospondanceAddr.children.cardContent.children.AddressWithCheckBoxContainer.children.addressContainer.children.tradeLocCity", "components.div.children.formwizardSecondStep.children.corrospondanceAddr.children.cardContent.children.AddressWithCheckBoxContainer.children.addressContainer.children.tradeLocDoorHouseNo", "components.div.children.formwizardSecondStep.children.corrospondanceAddr.children.cardContent.children.AddressWithCheckBoxContainer.children.addressContainer.children.tradeLocMohalla", "components.div.children.formwizardSecondStep.children.corrospondanceAddr.children.cardContent.children.AddressWithCheckBoxContainer.children.addressContainer.children.tradeLocPincode", "components.div.children.formwizardSecondStep.children.corrospondanceAddr.children.cardContent.children.AddressWithCheckBoxContainer.children.addressContainer.children.tradeLocStreetName"]
        },
        type: "array"
      }
    }),

    addressContainer: (0, _utils.getCommonContainer)({
      ...
      tradeLocMohalla: (0, _utils.getTextField)({
        label: {
          labelName: "Locality",
      ...
      tradeLocCity: (0, _utils.getTextField)({
        label: {
          labelName: "City",
...
var permanentAddr = exports.permanentAddr = (0, _utils.getCommonCard)({
  header: (0, _utils.getCommonTitle)({
