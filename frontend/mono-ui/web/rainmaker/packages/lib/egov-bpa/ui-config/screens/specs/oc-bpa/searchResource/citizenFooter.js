...
var bpaMakePayment = exports.bpaMakePayment = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(state, dispatch) {
    var status, billbService, makePaymentUrl;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            makePaymentUrl = process.env.REACT_APP_SELF_RUNNING === "true" ? "/egov-ui-framework/oc-bpa/citizen-pay?applicationNumber=" + applicationNumber + "&tenantId=" + tenant + "&businessService=" + billbService : "/egov-common/pay?consumerCode=" + applicationNumber + "&tenantId=" + tenant + "&businessService=" + billbService;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            bpaStatusAction = bpaStatus.includes("CITIZEN_ACTION_PENDING");
...
var citizenFooter = exports.citizenFooter = getCommonApplyFooter({
  ...
  submitButton: {
    ...
    onClickDefination: {
      action: "condition",
      callBack: _commons2.submitOCBpaApplication
    },
    roleDefination: {
      rolePath: "user-info.roles",
      action: "APPLY"
