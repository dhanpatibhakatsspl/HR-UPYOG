...
var _footer = require("../bpastakeholder/payResource/footer");

var _estimateDetails = require("../bpastakeholder/payResource/estimate-details");
...
var screenConfig = {
  ...
  beforeInitScreen: function beforeInitScreen(action, state, dispatch) {
    ...
    var queryObject = [{ key: "tenantId", value: tenantId }, { key: "businessService", value: "newTL" }];
