...
function PermitNumber(props) {
  ...
  return _react2.default.createElement(
    "div",
    { style: styles },
    _react2.default.createElement(_LabelContainer2.default, { labelName: "PermitNumber No.", labelKey: "BPA_APPLICATION_PERMIT_NO_CODE", dynamicArray: [number] })
  );
}

exports.default = PermitNumber;