...
var wrapRequestBody = function wrapRequestBody(requestBody, action, customRequestInfo, endPoint) {
  ...
  var userInfo = JSON.parse("" + localStorage.getItem('user-info') ? "" + localStorage.getItem('user-info') : '');
  if (endPoint.includes("_fetchbill")) {
    RequestInfo = (0, _extends3.default)({}, RequestInfo, { userInfo: userInfo });
  } else {
    RequestInfo = (0, _extends3.default)({}, RequestInfo, customRequestInfo);
  }
  RequestInfo = (0, _extends3.default)({}, RequestInfo, customRequestInfo);
  if ((0, _commons.isPublicSearch)()) delete RequestInfo.authToken;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(0, _some2.default)(queryObject, ["key", "tenantId"]) && _common2.default.singleInstance) {
              endPoint && !endPoint.includes("tenantId") && queryObject && queryObject.push({
                key: "tenantId",
                value: tenantId
              });
            }
          ...
          case 10:
            _context.next = 12;
            return instance.post(endPoint, wrapRequestBody(requestBody, action, customRequestInfo, endPoint));
