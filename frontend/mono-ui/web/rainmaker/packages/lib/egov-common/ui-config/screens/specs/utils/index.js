    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            _context.next = 19;
            return (0, _api2.httpRequest)("post", "/user/_search?tenantId=pb", "_search", [], {
              tenantId: "pb",
              userName: "" + ownerNo
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _api2.httpRequest)("post", "collection-services/receipts/_search", "", queryObject);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return (0, _api2.httpRequest)("post", "egov-mdms-service/v1/_get", "", queryObject);
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return (0, _api2.httpRequest)("post", "/billing-service/bill/v2/_fetchbill", "", queryObject);
          ...
          case 7:
            ...
            if (!window.location.pathname.includes('acknowledgement')) {
              dispatch((0, _actions2.toggleSnackbar)(true, { labelName: _context5.t0.message, labelKey: _context5.t0.message }, _context5.t0.message && _context5.t0.message.includes && _context5.t0.message.includes("No Demands Found") ? "warning" : "error"));
            }
...
var getOtherBillDetails = exports.getOtherBillDetails = function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return (0, _api2.httpRequest)("post", "/billing-service/bill/v2/_search", "", queryObject);
          ...
          case 7:
            ...
            dispatch((0, _actions2.toggleSnackbar)(true, { labelName: _context6.t0.message, labelKey: _context6.t0.message }, "error"));
  ...
  return function getOtherBillDetails(_x12, _x13) {
...
var searchBill = exports.searchBill = function () {
        ...
        switch (_context7.prev = _context7.next) {
          ...
          case 7:
            ...
            if (billData) {
              ...
              estimateData = createEstimateData(billData[0], billData[0].totalAmount);
  ...
  return function searchBill(_x14, _x15, _x16) {
    return _ref7.apply(this, arguments);
  };
}();

var createEstimateData = exports.createEstimateData = function createEstimateData(billObject, totalAmount) {
  var billDetails = billObject && billObject.billDetails;

  var forward = 0;
  if (totalAmount < 0) {
    billDetails.forEach(function (e) {
      e.billAccountDetails.forEach(function (cur) {
    ...
    var keyExist = false;
    billDetails[0].billAccountDetails.forEach(function (cur) {
      if (cur.taxHeadCode.indexOf("ADVANCE_CARRYFORWARD") > -1) {
        cur.amount = forward;
        keyExist = true;
      }
...
var getBusinessServiceMdmsData = exports.getBusinessServiceMdmsData = function () {
  var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(dispatch, tenantId) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 5:
            ...
            dispatch((0, _actions2.prepareFinalObject)("businessServiceMdmsData", payload.MdmsRes));
            _context8.next = 12;
            break;
  ...
  return function getBusinessServiceMdmsData(_x17, _x18) {
    return _ref8.apply(this, arguments);
  };
}();
var loadArrearsDetails = function () {
  var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee10(dispatch) {
    var Bill = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    var queries, endpoints, rb, resp, estimateData;
    return _regenerator2.default.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            if (!(Bill && Array.isArray(Bill) && Bill.length > 0 && Bill[0] && Bill[0].billDetails && Array.isArray(Bill[0].billDetails) && Bill[0].billDetails.length > 1)) {
              _context10.next = 12;
              break;
            }
            ...
            Bill[0].billDetails.map(function () {
              var _ref10 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee9(billDetail) {
                var query;
                  ...
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      case 0:
                        query = [{
                          key: "tenantId",
                          value: (0, _get2.default)(Bill[0], 'tenantId', "")
                        }, {
                          key: "consumerCode",
                          value: (0, _get2.default)(Bill[0], 'consumerCode', "")
                        }, {
                          key: "fromPeriod",
                          value: (0, _get2.default)(billDetail, 'fromPeriod', 0)
                        }, {
                          key: "toPeriod",
                          value: (0, _get2.default)(billDetail, 'toPeriod', 0)
                        }, {
                          key: "service",
                          value: (0, _get2.default)(Bill[0], 'businessService', "")
                        }, {
                          key: "retrieveOldest",
                          value: true
                        }];
            ...
            _context10.next = 7;
            return (0, _api.multiHttpRequest)(endpoints, "search", queries, rb);

          case 7:
            resp = _context10.sent;

            resp && resp.map(function (res, ind) {
              if (res && res.Bill) {
                if (res && res.Bill && res.Bill[0]) {
                  (0, _set2.default)(Bill[0].billDetails[ind], 'expiryDate', (0, _get2.default)(res, 'Bill[0].billDetails[0].expiryDate', 'NA'));
                  (0, _set2.default)(Bill[0].billDetails[ind], 'billNumber', (0, _get2.default)(res, 'Bill[0].billNumber', 'NA'));
                }
              }
            });
            dispatch((0, _actions2.prepareFinalObject)("ReceiptTemp[0].Bill", Bill));
            estimateData = createEstimateData(Bill[0], Bill[0].totalAmount);
  ...
  return function loadArrearsDetails(_x19) {
    return _ref9.apply(this, arguments);
  };
}();

var generateBill = exports.generateBill = function () {
  var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11(dispatch, consumerCode, tenantId, businessService) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            _context11.next = 6;
            return getBill(queryObj, dispatch);
          ...
          case 6:
            ...
            if (payload && payload.Bill[0]) {
              ...
              estimateData = createEstimateData(payload.Bill[0], payload.Bill[0].totalAmount);
          ...
          case 10:
            ...
            dispatch((0, _actions2.toggleSnackbar)(true, { labelName: _context11.t0.message, labelKey: _context11.t0.message }, "error"));
  ...
  return function generateBill(_x22, _x23, _x24, _x25) {
...
var getRequiredDocData = exports.getRequiredDocData = function () {
  ...
  return function getRequiredDocData(_x26, _x27, _x28) {
