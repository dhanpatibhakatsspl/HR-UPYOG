...
var getEstimateDataAfterAdhoc = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(state, dispatch) {
    var NOCRequestBody, NOCpayload, applicationNumber, tenantId, queryObj, billPayload, estimateData, billInRedux, mergedBillObj, collectionType, totalAmount;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0, _set2.default)(NOCRequestBody[0], "fireNOCDetails.action", "ADHOC");
          ...
          case 5:
            ...
            applicationNumber = (0, _get2.default)(NOCpayload, "FireNOCs[0].fireNOCDetails.applicationNumber");
            tenantId = (0, _get2.default)(NOCpayload, "FireNOCs[0].tenantId");
            ...
            _context.next = 12;
            return (0, _utils2.getBill)(queryObj, dispatch);
...
var updateAdhoc = function updateAdhoc(state, dispatch) {
  var penaltyAmount = (0, _get2.default)(state.screenConfiguration.preparedFinalObject, "FireNOCs[0].fireNOCDetails.additionalDetail.adhocPenalty");
  var rebateAmount = (0, _get2.default)(state.screenConfiguration.preparedFinalObject, "FireNOCs[0].fireNOCDetails.additionalDetail.adhocRebate");
  ...
  adhocPenaltyCard: (0, _utils.getCommonContainer)({
    ...
    penaltyAmountAndReasonContainer: (0, _utils.getCommonContainer)({
      ...
      penaltyReason: (0, _utils.getSelectField)({
        ...
        jsonPath: "FireNOCs[0].fireNOCDetails.additionalDetail.adhocPenaltyReason"
      })
    }),
  ...
  adhocRebateCard: (0, _utils.getCommonContainer)({
    ...
    rebateAmountAndReasonContainer: (0, _utils.getCommonContainer)({
      ...
      rebateReason: (0, _utils.getSelectField)({
        ...
        jsonPath: "FireNOCs[0].fireNOCDetails.additionalDetail.adhocRebateReason"
      }),
