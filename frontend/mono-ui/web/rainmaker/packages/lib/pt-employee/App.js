...
var App = function (_Component) {
  ...
  (0, _createClass3.default)(App, [{
    ...
    value: function componentDidMount() {
      ...
      fetchLocalizationLabel((0, _localStorageUtils.getLocale)() || "en_IN");
      // current location
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        toast && toast.open && !isEmpty(toast.message) && _react2.default.createElement(_components.Toast, {
          open: toast.open,
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var props = {};
  var spinner = state.common.spinner;

  var loading = ownProps.loading || spinner;
