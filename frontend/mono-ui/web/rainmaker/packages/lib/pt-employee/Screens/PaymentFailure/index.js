  ...
  function PaymentFailure() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PaymentFailure.__proto__ || Object.getPrototypeOf(PaymentFailure)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _match$params2 = match.params,
          assessmentNumber = _match$params2.assessmentNumber,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_AcknowledgementCard2.default, { acknowledgeType: "failed", receiptHeader: "PT_TRANSACTION_AMT", messageHeader: "PT_OOPS", message: "PT_FAILURE_MESSAGE", receiptNo: txnAmount ? 'Rs:' + txnAmount : txnAmount })
          ),
          _react2.default.createElement(_ActionFooter2.default, { key: 2, label2: "PT_RETRY_BUTTON", primaryAction: this.redirectToReview })
        )
      );
    }
  }]);
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  return { selProperty: selProperty, cities: cities, latestPropertyDetails: latestPropertyDetails, loading: loading };
};
