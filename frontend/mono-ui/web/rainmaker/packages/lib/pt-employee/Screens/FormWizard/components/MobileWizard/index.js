    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "flex-item" },
          _react2.default.createElement(_components.Button, { onClick: handleNext, fullWidth: true, label: _react2.default.createElement(_translationNode2.default, { buttonLabel: true, label: "PT_COMMONS_NEXT", color: "#ffffff" }) })
        )
      )
    )
  );
