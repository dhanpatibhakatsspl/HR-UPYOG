        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 16:
            ...
            data = response.Noc.map(function (item) {
              ...
              return _ref4 = {}, (0, _defineProperty3.default)(_ref4, "NOC_APP_NO_LABEL", item.applicationNo || "-"), (0, _defineProperty3.default)(_ref4, "NOC_SOURCE_MODULE_NUMBER", item.sourceRefId || "-"), (0, _defineProperty3.default)(_ref4, "NOC_MODULE_SOURCE_LABEL", (0, _utils.getTextToLocalMapping)("CS_COMMON_INBOX_" + item.source) || "-"), (0, _defineProperty3.default)(_ref4, "WF_INBOX_HEADER_CURRENT_OWNER", (0, _get2.default)(businessIdToOwnerMappingForNOC[item.applicationNo], "assignee", null) || "NA"), (0, _defineProperty3.default)(_ref4, "NOC_STATUS_LABEL", item.applicationStatus || "-"), _ref4;
            });


            dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResults", "props.data", data));
            dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResults", "props.rows", response.Noc.length));
