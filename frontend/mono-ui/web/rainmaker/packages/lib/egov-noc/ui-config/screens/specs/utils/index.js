...
exports.getTextToLocalMapping = exports.convertEpochToDate = exports.getNocSearchResults = exports.checkValueForNA = exports.prepareDocsInEmployee = exports.requiredDocumentsData = exports.getLoggedinUserRole = undefined;
...
var getNocSearchResults = exports.getNocSearchResults = function () {
    var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(queryObject, dispatch) {
        var response;
            ...
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 7:
                        ...
                        store.dispatch(toggleSnackbar(true, { labelName: _context3.t0.message, labelKey: _context3.t0.message }, "error"));
                        throw _context3.t0;
    ...
    return function getNocSearchResults(_x9, _x10) {
